...
// Profile Version = 21.188.1Release
// Tag = production/release/21.188.1-0-g5b0fbad
/////////////////////////////////////////////////////////////////////////////////////////////
...
#define FIT_MESG_NUM_SLEEP_DISRUPTION_SEVERITY_PERIOD                            ((FIT_MESG_NUM)470)
#define FIT_MESG_NUM_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY                         ((FIT_MESG_NUM)471)
...
#define FIT_MANUFACTURER_LUHONG_TECHNOLOGY                                       ((FIT_MANUFACTURER)153)
...
#define FIT_MANUFACTURER_TEKTRO_RACING_PRODUCTS                                  ((FIT_MANUFACTURER)333)
#define FIT_MANUFACTURER_DARAD_INNOVATION_CORPORATION                            ((FIT_MANUFACTURER)334)
#define FIT_MANUFACTURER_CYCLOPTIM                                               ((FIT_MANUFACTURER)335)
#define FIT_MANUFACTURER_RUNNA                                                   ((FIT_MANUFACTURER)337)
...
#define FIT_GARMIN_PRODUCT_FR245                                                 ((FIT_GARMIN_PRODUCT)3076)
#define FIT_GARMIN_PRODUCT_FR245_MUSIC                                           ((FIT_GARMIN_PRODUCT)3077)
...
#define FIT_GARMIN_PRODUCT_FR45                                                  ((FIT_GARMIN_PRODUCT)3282)
...
#define FIT_GARMIN_PRODUCT_VENUSQ_MUSIC                                          ((FIT_GARMIN_PRODUCT)3596)
#define FIT_GARMIN_PRODUCT_VENUSQ_MUSIC_V2                                       ((FIT_GARMIN_PRODUCT)3599)
...
#define FIT_GARMIN_PRODUCT_GNSS                                                  ((FIT_GARMIN_PRODUCT)3865) // Airoha AG3335M Family
#define FIT_GARMIN_PRODUCT_FR55                                                  ((FIT_GARMIN_PRODUCT)3869)
#define FIT_GARMIN_PRODUCT_INSTINCT_2                                            ((FIT_GARMIN_PRODUCT)3888)
#define FIT_GARMIN_PRODUCT_INSTINCT_2S                                           ((FIT_GARMIN_PRODUCT)3889)
...
#define FIT_GARMIN_PRODUCT_RALLY_X10                                             ((FIT_GARMIN_PRODUCT)4525) // Rally 110/210
...
#define FIT_GARMIN_PRODUCT_INSTINCTE_40MM                                        ((FIT_GARMIN_PRODUCT)4583)
#define FIT_GARMIN_PRODUCT_INSTINCTE_45MM                                        ((FIT_GARMIN_PRODUCT)4584)
#define FIT_GARMIN_PRODUCT_INSTINCT3_SOLAR_45MM                                  ((FIT_GARMIN_PRODUCT)4585)
#define FIT_GARMIN_PRODUCT_INSTINCT3_AMOLED_45MM                                 ((FIT_GARMIN_PRODUCT)4586)
#define FIT_GARMIN_PRODUCT_INSTINCT3_AMOLED_50MM                                 ((FIT_GARMIN_PRODUCT)4587)
#define FIT_GARMIN_PRODUCT_DESCENT_G2                                            ((FIT_GARMIN_PRODUCT)4588)
#define FIT_GARMIN_PRODUCT_VENU_X1                                               ((FIT_GARMIN_PRODUCT)4603)
#define FIT_GARMIN_PRODUCT_HRM_200                                               ((FIT_GARMIN_PRODUCT)4606)
#define FIT_GARMIN_PRODUCT_VIVOACTIVE6                                           ((FIT_GARMIN_PRODUCT)4625)
#define FIT_GARMIN_PRODUCT_FENIX8_PRO                                            ((FIT_GARMIN_PRODUCT)4631)
#define FIT_GARMIN_PRODUCT_EDGE_550                                              ((FIT_GARMIN_PRODUCT)4633)
#define FIT_GARMIN_PRODUCT_EDGE_850                                              ((FIT_GARMIN_PRODUCT)4634)
#define FIT_GARMIN_PRODUCT_VENU4                                                 ((FIT_GARMIN_PRODUCT)4643)
#define FIT_GARMIN_PRODUCT_VENU4S                                                ((FIT_GARMIN_PRODUCT)4644)
#define FIT_GARMIN_PRODUCT_APPROACHS44                                           ((FIT_GARMIN_PRODUCT)4647)
#define FIT_GARMIN_PRODUCT_EDGE_MTB                                              ((FIT_GARMIN_PRODUCT)4655)
#define FIT_GARMIN_PRODUCT_APPROACHS50                                           ((FIT_GARMIN_PRODUCT)4656)
#define FIT_GARMIN_PRODUCT_FENIX_E                                               ((FIT_GARMIN_PRODUCT)4666)
#define FIT_GARMIN_PRODUCT_BOUNCE2                                               ((FIT_GARMIN_PRODUCT)4745)
#define FIT_GARMIN_PRODUCT_INSTINCT3_SOLAR_50MM                                  ((FIT_GARMIN_PRODUCT)4759)
#define FIT_GARMIN_PRODUCT_TACTIX8_AMOLED                                        ((FIT_GARMIN_PRODUCT)4775)
#define FIT_GARMIN_PRODUCT_TACTIX8_SOLAR                                         ((FIT_GARMIN_PRODUCT)4776)
#define FIT_GARMIN_PRODUCT_D2_MACH2                                              ((FIT_GARMIN_PRODUCT)4879)
#define FIT_GARMIN_PRODUCT_INSTINCT_CROSSOVER_AMOLED                             ((FIT_GARMIN_PRODUCT)4678)
#define FIT_GARMIN_PRODUCT_D2_AIR_X15                                            ((FIT_GARMIN_PRODUCT)4944)
...
#define FIT_SWIM_STROKE_IM_BY_ROUND                                              ((FIT_SWIM_STROKE)7) // For repeated workout steps, a new individual medly stroke is used for each round.
#define FIT_SWIM_STROKE_RIMO                                                     ((FIT_SWIM_STROKE)8) // Reverse IM Order
...
#define FIT_EXERCISE_CATEGORY_BIKE                                               ((FIT_EXERCISE_CATEGORY)33)
#define FIT_EXERCISE_CATEGORY_CARDIO_SENSORS                                     ((FIT_EXERCISE_CATEGORY)34) // Exercises within workouts that use GPS/sensors rather than rep counting
#define FIT_EXERCISE_CATEGORY_MOVE                                               ((FIT_EXERCISE_CATEGORY)35)
#define FIT_EXERCISE_CATEGORY_POSE                                               ((FIT_EXERCISE_CATEGORY)36)
#define FIT_EXERCISE_CATEGORY_BANDED_EXERCISES                                   ((FIT_EXERCISE_CATEGORY)37)
#define FIT_EXERCISE_CATEGORY_BATTLE_ROPE                                        ((FIT_EXERCISE_CATEGORY)38)
#define FIT_EXERCISE_CATEGORY_ELLIPTICAL                                         ((FIT_EXERCISE_CATEGORY)39)
#define FIT_EXERCISE_CATEGORY_FLOOR_CLIMB                                        ((FIT_EXERCISE_CATEGORY)40)
#define FIT_EXERCISE_CATEGORY_INDOOR_BIKE                                        ((FIT_EXERCISE_CATEGORY)41)
#define FIT_EXERCISE_CATEGORY_INDOOR_ROW                                         ((FIT_EXERCISE_CATEGORY)42)
#define FIT_EXERCISE_CATEGORY_LADDER                                             ((FIT_EXERCISE_CATEGORY)43)
#define FIT_EXERCISE_CATEGORY_SANDBAG                                            ((FIT_EXERCISE_CATEGORY)44)
#define FIT_EXERCISE_CATEGORY_SLED                                               ((FIT_EXERCISE_CATEGORY)45)
#define FIT_EXERCISE_CATEGORY_SLEDGE_HAMMER                                      ((FIT_EXERCISE_CATEGORY)46)
#define FIT_EXERCISE_CATEGORY_STAIR_STEPPER                                      ((FIT_EXERCISE_CATEGORY)47)
#define FIT_EXERCISE_CATEGORY_SUSPENSION                                         ((FIT_EXERCISE_CATEGORY)49)
#define FIT_EXERCISE_CATEGORY_TIRE                                               ((FIT_EXERCISE_CATEGORY)50)
#define FIT_EXERCISE_CATEGORY_RUN_INDOOR                                         ((FIT_EXERCISE_CATEGORY)52)
#define FIT_EXERCISE_CATEGORY_BIKE_OUTDOOR                                       ((FIT_EXERCISE_CATEGORY)53)
...
#define FIT_CARDIO_EXERCISE_NAME_ELLIPTICAL                                      ((FIT_CARDIO_EXERCISE_NAME)22)
#define FIT_CARDIO_EXERCISE_NAME_SPINNING                                        ((FIT_CARDIO_EXERCISE_NAME)23)
#define FIT_CARDIO_EXERCISE_NAME_POLE_PADDLE_FORWARD_WHEELCHAIR                  ((FIT_CARDIO_EXERCISE_NAME)24)
#define FIT_CARDIO_EXERCISE_NAME_POLE_PADDLE_BACKWARD_WHEELCHAIR                 ((FIT_CARDIO_EXERCISE_NAME)25)
#define FIT_CARDIO_EXERCISE_NAME_POLE_HANDCYCLE_FORWARD_WHEELCHAIR               ((FIT_CARDIO_EXERCISE_NAME)26)
#define FIT_CARDIO_EXERCISE_NAME_POLE_HANDCYCLE_BACKWARD_WHEELCHAIR              ((FIT_CARDIO_EXERCISE_NAME)27)
#define FIT_CARDIO_EXERCISE_NAME_POLE_RAINBOW_WHEELCHAIR                         ((FIT_CARDIO_EXERCISE_NAME)28)
#define FIT_CARDIO_EXERCISE_NAME_DOUBLE_PUNCH_FORWARD_WHEELCHAIR                 ((FIT_CARDIO_EXERCISE_NAME)29)
#define FIT_CARDIO_EXERCISE_NAME_DOUBLE_PUNCH_DOWN_WHEELCHAIR                    ((FIT_CARDIO_EXERCISE_NAME)30)
#define FIT_CARDIO_EXERCISE_NAME_DOUBLE_PUNCH_SIDEWAYS_WHEELCHAIR                ((FIT_CARDIO_EXERCISE_NAME)31)
#define FIT_CARDIO_EXERCISE_NAME_DOUBLE_PUNCH_UP_WHEELCHAIR                      ((FIT_CARDIO_EXERCISE_NAME)32)
#define FIT_CARDIO_EXERCISE_NAME_SIT_SKI_WHEELCHAIR                              ((FIT_CARDIO_EXERCISE_NAME)33)
#define FIT_CARDIO_EXERCISE_NAME_SITTING_JACKS_WHEELCHAIR                        ((FIT_CARDIO_EXERCISE_NAME)34)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH_FORWARD_WHEELCHAIR                        ((FIT_CARDIO_EXERCISE_NAME)35)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH_DOWN_WHEELCHAIR                           ((FIT_CARDIO_EXERCISE_NAME)36)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH_SIDEWAYS_WHEELCHAIR                       ((FIT_CARDIO_EXERCISE_NAME)37)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH_UP_WHEELCHAIR                             ((FIT_CARDIO_EXERCISE_NAME)38)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH_BAG_WHEELCHAIR                            ((FIT_CARDIO_EXERCISE_NAME)39)
#define FIT_CARDIO_EXERCISE_NAME_POLE_DD_FF_UU_WHEELCHAIR                        ((FIT_CARDIO_EXERCISE_NAME)40)
#define FIT_CARDIO_EXERCISE_NAME_BUTTERFLY_ARMS_WHEELCHAIR                       ((FIT_CARDIO_EXERCISE_NAME)41)
#define FIT_CARDIO_EXERCISE_NAME_PUNCH                                           ((FIT_CARDIO_EXERCISE_NAME)42)
...
#define FIT_CARRY_EXERCISE_NAME_DUMBBELL_WAITER_CARRY                            ((FIT_CARRY_EXERCISE_NAME)5)
#define FIT_CARRY_EXERCISE_NAME_FARMERS_CARRY_WALK_LUNGE                         ((FIT_CARRY_EXERCISE_NAME)6)
#define FIT_CARRY_EXERCISE_NAME_FARMERS_CARRY                                    ((FIT_CARRY_EXERCISE_NAME)7)
#define FIT_CARRY_EXERCISE_NAME_FARMERS_CARRY_ON_TOES                            ((FIT_CARRY_EXERCISE_NAME)8)
...
#define FIT_CORE_EXERCISE_NAME_BICEP_CURL_WITH_LEG_EXTENSION_WITH_WEIGHTS        ((FIT_CORE_EXERCISE_NAME)73)
#define FIT_CORE_EXERCISE_NAME_HANGING_L_SIT                                     ((FIT_CORE_EXERCISE_NAME)75)
#define FIT_CORE_EXERCISE_NAME_LOWER_LIFT_WITH_WEIGHTS                           ((FIT_CORE_EXERCISE_NAME)77)
#define FIT_CORE_EXERCISE_NAME_RING_L_SIT                                        ((FIT_CORE_EXERCISE_NAME)79)
#define FIT_CORE_EXERCISE_NAME_ROWING_1_WITH_WEIGHTS                             ((FIT_CORE_EXERCISE_NAME)80)
#define FIT_CORE_EXERCISE_NAME_ROWING_2_WITH_WEIGHTS                             ((FIT_CORE_EXERCISE_NAME)81)
#define FIT_CORE_EXERCISE_NAME_SCISSORS_WITH_WEIGHTS                             ((FIT_CORE_EXERCISE_NAME)82)
#define FIT_CORE_EXERCISE_NAME_SINGLE_LEG_STRETCH_WITH_WEIGHTS                   ((FIT_CORE_EXERCISE_NAME)83)
#define FIT_CORE_EXERCISE_NAME_TOES_TO_ELBOWS                                    ((FIT_CORE_EXERCISE_NAME)84)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_CRISS_CROSS                              ((FIT_CORE_EXERCISE_NAME)85)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_DOUBLE_LEG_STRETCH                       ((FIT_CORE_EXERCISE_NAME)86)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_THE_HUNDRED                              ((FIT_CORE_EXERCISE_NAME)87)
#define FIT_CORE_EXERCISE_NAME_L_SIT                                             ((FIT_CORE_EXERCISE_NAME)88)
#define FIT_CORE_EXERCISE_NAME_TURKISH_GET_UP                                    ((FIT_CORE_EXERCISE_NAME)89)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_RING_L_SIT                               ((FIT_CORE_EXERCISE_NAME)90)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_HANGING_L_SIT                            ((FIT_CORE_EXERCISE_NAME)91)
#define FIT_CORE_EXERCISE_NAME_WEIGHTED_L_SIT                                    ((FIT_CORE_EXERCISE_NAME)92)
#define FIT_CORE_EXERCISE_NAME_SIDE_BEND_LOW_WHEELCHAIR                          ((FIT_CORE_EXERCISE_NAME)93)
#define FIT_CORE_EXERCISE_NAME_SIDE_BEND_MID_WHEELCHAIR                          ((FIT_CORE_EXERCISE_NAME)94)
#define FIT_CORE_EXERCISE_NAME_SIDE_BEND_HIGH_WHEELCHAIR                         ((FIT_CORE_EXERCISE_NAME)95)
#define FIT_CORE_EXERCISE_NAME_SEATED_SIDE_BEND                                  ((FIT_CORE_EXERCISE_NAME)96)
...
#define FIT_CRUNCH_EXERCISE_NAME_LEG_CLIMB_CRUNCH                                ((FIT_CRUNCH_EXERCISE_NAME)86)
...
#define FIT_CURL_EXERCISE_NAME_ONE_ARM_CONCENTRATION_CURL                        ((FIT_CURL_EXERCISE_NAME)44)
#define FIT_CURL_EXERCISE_NAME_STANDING_ZOTTMAN_BICEPS_CURL                      ((FIT_CURL_EXERCISE_NAME)45)
#define FIT_CURL_EXERCISE_NAME_DUMBBELL_BICEPS_CURL                              ((FIT_CURL_EXERCISE_NAME)46)
#define FIT_CURL_EXERCISE_NAME_DRAG_CURL_WHEELCHAIR                              ((FIT_CURL_EXERCISE_NAME)47)
#define FIT_CURL_EXERCISE_NAME_DUMBBELL_BICEPS_CURL_WHEELCHAIR                   ((FIT_CURL_EXERCISE_NAME)48)
#define FIT_CURL_EXERCISE_NAME_BOTTLE_CURL                                       ((FIT_CURL_EXERCISE_NAME)49)
#define FIT_CURL_EXERCISE_NAME_SEATED_BOTTLE_CURL                                ((FIT_CURL_EXERCISE_NAME)50)
...
#define FIT_DEADLIFT_EXERCISE_NAME_KETTLEBELL_DEADLIFT                           ((FIT_DEADLIFT_EXERCISE_NAME)20)
#define FIT_DEADLIFT_EXERCISE_NAME_KETTLEBELL_SUMO_DEADLIFT                      ((FIT_DEADLIFT_EXERCISE_NAME)21)
#define FIT_DEADLIFT_EXERCISE_NAME_ROMANIAN_DEADLIFT                             ((FIT_DEADLIFT_EXERCISE_NAME)23)
#define FIT_DEADLIFT_EXERCISE_NAME_SINGLE_LEG_ROMANIAN_DEADLIFT_CIRCUIT          ((FIT_DEADLIFT_EXERCISE_NAME)24)
#define FIT_DEADLIFT_EXERCISE_NAME_STRAIGHT_LEG_DEADLIFT                         ((FIT_DEADLIFT_EXERCISE_NAME)25)
...
#define FIT_FLYE_EXERCISE_NAME_FACE_DOWN_INCLINE_REVERSE_FLYE                    ((FIT_FLYE_EXERCISE_NAME)10)
#define FIT_FLYE_EXERCISE_NAME_INCLINE_REVERSE_FLYE                              ((FIT_FLYE_EXERCISE_NAME)11)
#define FIT_FLYE_EXERCISE_NAME_REAR_DELT_FLY_WHEELCHAIR                          ((FIT_FLYE_EXERCISE_NAME)12)
...
#define FIT_HIP_STABILITY_EXERCISE_NAME_LYING_ABDUCTION_STRETCH                  ((FIT_HIP_STABILITY_EXERCISE_NAME)34)
...
#define FIT_HIP_SWING_EXERCISE_NAME_ONE_ARM_SWING                                ((FIT_HIP_SWING_EXERCISE_NAME)3)
...
#define FIT_LATERAL_RAISE_EXERCISE_NAME_DUMBBELL_LATERAL_RAISE                   ((FIT_LATERAL_RAISE_EXERCISE_NAME)34)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_RING_DIP_KIPPING                         ((FIT_LATERAL_RAISE_EXERCISE_NAME)36)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_WALL_WALK                                ((FIT_LATERAL_RAISE_EXERCISE_NAME)37)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_DUMBBELL_FRONT_RAISE_WHEELCHAIR          ((FIT_LATERAL_RAISE_EXERCISE_NAME)38)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_DUMBBELL_LATERAL_RAISE_WHEELCHAIR        ((FIT_LATERAL_RAISE_EXERCISE_NAME)39)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_POLE_DOUBLE_ARM_OVERHEAD_AND_FORWARD_WHEELCHAIR ((FIT_LATERAL_RAISE_EXERCISE_NAME)40)
#define FIT_LATERAL_RAISE_EXERCISE_NAME_POLE_STRAIGHT_ARM_OVERHEAD_WHEELCHAIR    ((FIT_LATERAL_RAISE_EXERCISE_NAME)41)
...
#define FIT_LEG_CURL_EXERCISE_NAME_BAND_GOOD_MORNING                             ((FIT_LEG_CURL_EXERCISE_NAME)12)
#define FIT_LEG_CURL_EXERCISE_NAME_BAR_GOOD_MORNING                              ((FIT_LEG_CURL_EXERCISE_NAME)13)
...
#define FIT_LUNGE_EXERCISE_NAME_ALTERNATING_DUMBBELL_LUNGE                       ((FIT_LUNGE_EXERCISE_NAME)81)
#define FIT_LUNGE_EXERCISE_NAME_DUMBBELL_REVERSE_LUNGE                           ((FIT_LUNGE_EXERCISE_NAME)82)
#define FIT_LUNGE_EXERCISE_NAME_OVERHEAD_DUMBBELL_LUNGE                          ((FIT_LUNGE_EXERCISE_NAME)83)
#define FIT_LUNGE_EXERCISE_NAME_SCISSOR_POWER_SWITCH                             ((FIT_LUNGE_EXERCISE_NAME)84)
#define FIT_LUNGE_EXERCISE_NAME_DUMBBELL_OVERHEAD_WALKING_LUNGE                  ((FIT_LUNGE_EXERCISE_NAME)85)
#define FIT_LUNGE_EXERCISE_NAME_CURTSY_LUNGE                                     ((FIT_LUNGE_EXERCISE_NAME)86)
#define FIT_LUNGE_EXERCISE_NAME_WEIGHTED_CURTSY_LUNGE                            ((FIT_LUNGE_EXERCISE_NAME)87)
#define FIT_LUNGE_EXERCISE_NAME_WEIGHTED_SHIFTING_SIDE_LUNGE                     ((FIT_LUNGE_EXERCISE_NAME)88)
#define FIT_LUNGE_EXERCISE_NAME_WEIGHTED_SIDE_LUNGE_AND_PRESS                    ((FIT_LUNGE_EXERCISE_NAME)89)
#define FIT_LUNGE_EXERCISE_NAME_WEIGHTED_SIDE_LUNGE_JUMP_OFF                     ((FIT_LUNGE_EXERCISE_NAME)90)
...
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_DUMBBELL_HANG_SNATCH                      ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)21)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_DUMBBELL_POWER_CLEAN_AND_JERK             ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)22)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_DUMBBELL_POWER_CLEAN_AND_PUSH_PRESS       ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)23)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_DUMBBELL_POWER_CLEAN_AND_STRICT_PRESS     ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)24)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_DUMBBELL_SNATCH                           ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)25)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_MEDICINE_BALL_CLEAN                       ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)26)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_CLEAN_AND_PRESS                           ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)27)
#define FIT_OLYMPIC_LIFT_EXERCISE_NAME_SNATCH                                    ((FIT_OLYMPIC_LIFT_EXERCISE_NAME)28)
...
#define FIT_PLANK_EXERCISE_NAME_RING_PLANK_SPRAWLS                               ((FIT_PLANK_EXERCISE_NAME)135)
...
#define FIT_PLYO_EXERCISE_NAME_BOX_JUMP                                          ((FIT_PLYO_EXERCISE_NAME)33)
#define FIT_PLYO_EXERCISE_NAME_BOX_JUMP_OVERS                                    ((FIT_PLYO_EXERCISE_NAME)34)
#define FIT_PLYO_EXERCISE_NAME_BOX_JUMP_OVERS_OVER_THE_BOX                       ((FIT_PLYO_EXERCISE_NAME)35)
#define FIT_PLYO_EXERCISE_NAME_STAR_JUMP_SQUATS                                  ((FIT_PLYO_EXERCISE_NAME)36)
#define FIT_PLYO_EXERCISE_NAME_JUMP_SQUAT                                        ((FIT_PLYO_EXERCISE_NAME)37)
...
#define FIT_PULL_UP_EXERCISE_NAME_CHIN_UP                                        ((FIT_PULL_UP_EXERCISE_NAME)39)
#define FIT_PULL_UP_EXERCISE_NAME_NEUTRAL_GRIP_CHIN_UP                           ((FIT_PULL_UP_EXERCISE_NAME)40)
#define FIT_PULL_UP_EXERCISE_NAME_WEIGHTED_CHIN_UP                               ((FIT_PULL_UP_EXERCISE_NAME)41)
#define FIT_PULL_UP_EXERCISE_NAME_BAND_ASSISTED_PULL_UP                          ((FIT_PULL_UP_EXERCISE_NAME)42)
#define FIT_PULL_UP_EXERCISE_NAME_NEUTRAL_GRIP_PULL_UP                           ((FIT_PULL_UP_EXERCISE_NAME)43)
#define FIT_PULL_UP_EXERCISE_NAME_WEIGHTED_NEUTRAL_GRIP_CHIN_UP                  ((FIT_PULL_UP_EXERCISE_NAME)44)
#define FIT_PULL_UP_EXERCISE_NAME_WEIGHTED_NEUTRAL_GRIP_PULL_UP                  ((FIT_PULL_UP_EXERCISE_NAME)45)
...
#define FIT_PUSH_UP_EXERCISE_NAME_DYNAMIC_PUSH_UP                                ((FIT_PUSH_UP_EXERCISE_NAME)79)
#define FIT_PUSH_UP_EXERCISE_NAME_KIPPING_HANDSTAND_PUSH_UP                      ((FIT_PUSH_UP_EXERCISE_NAME)80)
#define FIT_PUSH_UP_EXERCISE_NAME_SHOULDER_TAPPING_PUSH_UP                       ((FIT_PUSH_UP_EXERCISE_NAME)81)
#define FIT_PUSH_UP_EXERCISE_NAME_BICEPS_PUSH_UP                                 ((FIT_PUSH_UP_EXERCISE_NAME)82)
#define FIT_PUSH_UP_EXERCISE_NAME_HINDU_PUSH_UP                                  ((FIT_PUSH_UP_EXERCISE_NAME)83)
#define FIT_PUSH_UP_EXERCISE_NAME_PIKE_PUSH_UP                                   ((FIT_PUSH_UP_EXERCISE_NAME)84)
#define FIT_PUSH_UP_EXERCISE_NAME_WIDE_GRIP_PUSH_UP                              ((FIT_PUSH_UP_EXERCISE_NAME)85)
#define FIT_PUSH_UP_EXERCISE_NAME_WEIGHTED_BICEPS_PUSH_UP                        ((FIT_PUSH_UP_EXERCISE_NAME)86)
#define FIT_PUSH_UP_EXERCISE_NAME_WEIGHTED_HINDU_PUSH_UP                         ((FIT_PUSH_UP_EXERCISE_NAME)87)
#define FIT_PUSH_UP_EXERCISE_NAME_WEIGHTED_PIKE_PUSH_UP                          ((FIT_PUSH_UP_EXERCISE_NAME)88)
#define FIT_PUSH_UP_EXERCISE_NAME_KIPPING_PARALLETTE_HANDSTAND_PUSH_UP           ((FIT_PUSH_UP_EXERCISE_NAME)89)
#define FIT_PUSH_UP_EXERCISE_NAME_WALL_PUSH_UP                                   ((FIT_PUSH_UP_EXERCISE_NAME)90)
...
#define FIT_ROW_EXERCISE_NAME_ALTERNATING_DUMBBELL_ROW                           ((FIT_ROW_EXERCISE_NAME)34)
#define FIT_ROW_EXERCISE_NAME_INVERTED_ROW                                       ((FIT_ROW_EXERCISE_NAME)35)
#define FIT_ROW_EXERCISE_NAME_ROW                                                ((FIT_ROW_EXERCISE_NAME)36)
#define FIT_ROW_EXERCISE_NAME_WEIGHTED_ROW                                       ((FIT_ROW_EXERCISE_NAME)37)
#define FIT_ROW_EXERCISE_NAME_INDOOR_ROW                                         ((FIT_ROW_EXERCISE_NAME)38)
#define FIT_ROW_EXERCISE_NAME_BANDED_FACE_PULLS                                  ((FIT_ROW_EXERCISE_NAME)39)
#define FIT_ROW_EXERCISE_NAME_CHEST_SUPPORTED_DUMBBELL_ROW                       ((FIT_ROW_EXERCISE_NAME)40)
#define FIT_ROW_EXERCISE_NAME_DECLINE_RING_ROW                                   ((FIT_ROW_EXERCISE_NAME)41)
#define FIT_ROW_EXERCISE_NAME_ELEVATED_RING_ROW                                  ((FIT_ROW_EXERCISE_NAME)42)
#define FIT_ROW_EXERCISE_NAME_RDL_BENT_OVER_ROW_WITH_BARBELL_DUMBBELL            ((FIT_ROW_EXERCISE_NAME)43)
#define FIT_ROW_EXERCISE_NAME_RING_ROW                                           ((FIT_ROW_EXERCISE_NAME)44)
#define FIT_ROW_EXERCISE_NAME_BARBELL_ROW                                        ((FIT_ROW_EXERCISE_NAME)45)
#define FIT_ROW_EXERCISE_NAME_BENT_OVER_ROW_WITH_BARBELL                         ((FIT_ROW_EXERCISE_NAME)46)
#define FIT_ROW_EXERCISE_NAME_BENT_OVER_ROW_WITH_DUMBELL                         ((FIT_ROW_EXERCISE_NAME)47)
#define FIT_ROW_EXERCISE_NAME_SEATED_UNDERHAND_GRIP_CABLE_ROW                    ((FIT_ROW_EXERCISE_NAME)48)
#define FIT_ROW_EXERCISE_NAME_TRX_INVERTED_ROW                                   ((FIT_ROW_EXERCISE_NAME)49)
#define FIT_ROW_EXERCISE_NAME_WEIGHTED_INVERTED_ROW                              ((FIT_ROW_EXERCISE_NAME)50)
#define FIT_ROW_EXERCISE_NAME_WEIGHTED_TRX_INVERTED_ROW                          ((FIT_ROW_EXERCISE_NAME)51)
#define FIT_ROW_EXERCISE_NAME_DUMBBELL_ROW_WHEELCHAIR                            ((FIT_ROW_EXERCISE_NAME)52)
...
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_DUMBBELL_SHOULDER_PRESS                 ((FIT_SHOULDER_PRESS_EXERCISE_NAME)24)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_MILITARY_PRESS                          ((FIT_SHOULDER_PRESS_EXERCISE_NAME)25)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_STRICT_PRESS                            ((FIT_SHOULDER_PRESS_EXERCISE_NAME)27)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_DUMBBELL_FRONT_RAISE                    ((FIT_SHOULDER_PRESS_EXERCISE_NAME)28)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_DUMBBELL_CURL_TO_OVERHEAD_PRESS_WHEELCHAIR ((FIT_SHOULDER_PRESS_EXERCISE_NAME)29)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_ARNOLD_PRESS_WHEELCHAIR                 ((FIT_SHOULDER_PRESS_EXERCISE_NAME)30)
#define FIT_SHOULDER_PRESS_EXERCISE_NAME_OVERHEAD_DUMBBELL_PRESS_WHEELCHAIR      ((FIT_SHOULDER_PRESS_EXERCISE_NAME)31)
...
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_CABLE_INTERNAL_ROTATION             ((FIT_SHOULDER_STABILITY_EXERCISE_NAME)33)
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_LYING_INTERNAL_ROTATION             ((FIT_SHOULDER_STABILITY_EXERCISE_NAME)34)
#define FIT_SHOULDER_STABILITY_EXERCISE_NAME_SEATED_DUMBBELL_INTERNAL_ROTATION   ((FIT_SHOULDER_STABILITY_EXERCISE_NAME)35)
...
#define FIT_SHRUG_EXERCISE_NAME_WIDE_GRIP_BARBELL_SHRUG                          ((FIT_SHRUG_EXERCISE_NAME)17)
#define FIT_SHRUG_EXERCISE_NAME_BEHIND_THE_BACK_SHRUG                            ((FIT_SHRUG_EXERCISE_NAME)18)
#define FIT_SHRUG_EXERCISE_NAME_DUMBBELL_SHRUG_WHEELCHAIR                        ((FIT_SHRUG_EXERCISE_NAME)19)
#define FIT_SHRUG_EXERCISE_NAME_SHRUG_WHEELCHAIR                                 ((FIT_SHRUG_EXERCISE_NAME)20)
#define FIT_SHRUG_EXERCISE_NAME_SHRUG_ARM_DOWN_WHEELCHAIR                        ((FIT_SHRUG_EXERCISE_NAME)21)
#define FIT_SHRUG_EXERCISE_NAME_SHRUG_ARM_MID_WHEELCHAIR                         ((FIT_SHRUG_EXERCISE_NAME)22)
#define FIT_SHRUG_EXERCISE_NAME_SHRUG_ARM_UP_WHEELCHAIR                          ((FIT_SHRUG_EXERCISE_NAME)23)
#define FIT_SHRUG_EXERCISE_NAME_UPRIGHT_ROW                                      ((FIT_SHRUG_EXERCISE_NAME)24)
...
#define FIT_SIT_UP_EXERCISE_NAME_GHD_SIT_UPS                                     ((FIT_SIT_UP_EXERCISE_NAME)38)
#define FIT_SIT_UP_EXERCISE_NAME_SIT_UP_TURKISH_GET_UP                           ((FIT_SIT_UP_EXERCISE_NAME)39)
#define FIT_SIT_UP_EXERCISE_NAME_RUSSIAN_TWIST_ON_SWISS_BALL                     ((FIT_SIT_UP_EXERCISE_NAME)40)
...
#define FIT_SQUAT_EXERCISE_NAME_ALTERNATING_BOX_DUMBBELL_STEP_UPS                ((FIT_SQUAT_EXERCISE_NAME)92)
#define FIT_SQUAT_EXERCISE_NAME_DUMBBELL_OVERHEAD_SQUAT_SINGLE_ARM               ((FIT_SQUAT_EXERCISE_NAME)93)
#define FIT_SQUAT_EXERCISE_NAME_DUMBBELL_SQUAT_SNATCH                            ((FIT_SQUAT_EXERCISE_NAME)94)
#define FIT_SQUAT_EXERCISE_NAME_MEDICINE_BALL_SQUAT                              ((FIT_SQUAT_EXERCISE_NAME)95)
#define FIT_SQUAT_EXERCISE_NAME_WALL_BALL_SQUAT_AND_PRESS                        ((FIT_SQUAT_EXERCISE_NAME)97)
#define FIT_SQUAT_EXERCISE_NAME_SQUAT_AMERICAN_SWING                             ((FIT_SQUAT_EXERCISE_NAME)98)
#define FIT_SQUAT_EXERCISE_NAME_AIR_SQUAT                                        ((FIT_SQUAT_EXERCISE_NAME)100)
#define FIT_SQUAT_EXERCISE_NAME_DUMBBELL_THRUSTERS                               ((FIT_SQUAT_EXERCISE_NAME)101)
#define FIT_SQUAT_EXERCISE_NAME_OVERHEAD_BARBELL_SQUAT                           ((FIT_SQUAT_EXERCISE_NAME)102)
...
#define FIT_TOTAL_BODY_EXERCISE_NAME_BARBELL_BURPEE                              ((FIT_TOTAL_BODY_EXERCISE_NAME)13)
#define FIT_TOTAL_BODY_EXERCISE_NAME_BURPEE_BOX_JUMP_OVER_YES_LITERALLY_JUMPING_OVER_THE_BOX ((FIT_TOTAL_BODY_EXERCISE_NAME)15)
#define FIT_TOTAL_BODY_EXERCISE_NAME_BURPEE_BOX_JUMP_STEP_UP_OVER                ((FIT_TOTAL_BODY_EXERCISE_NAME)16)
#define FIT_TOTAL_BODY_EXERCISE_NAME_LATERAL_BARBELL_BURPEE                      ((FIT_TOTAL_BODY_EXERCISE_NAME)17)
#define FIT_TOTAL_BODY_EXERCISE_NAME_TOTAL_BODY_BURPEE_OVER_BAR                  ((FIT_TOTAL_BODY_EXERCISE_NAME)18)
#define FIT_TOTAL_BODY_EXERCISE_NAME_BURPEE_BOX_JUMP_OVER                        ((FIT_TOTAL_BODY_EXERCISE_NAME)19)
#define FIT_TOTAL_BODY_EXERCISE_NAME_BURPEE_WHEELCHAIR                           ((FIT_TOTAL_BODY_EXERCISE_NAME)20)
...
#define FIT_MOVE_EXERCISE_NAME_ARCH_AND_CURL                                     ((FIT_MOVE_EXERCISE_NAME)0)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_WITH_BALL_BAND_AND_WEIGHT             ((FIT_MOVE_EXERCISE_NAME)1)
#define FIT_MOVE_EXERCISE_NAME_ARM_STRETCH                                       ((FIT_MOVE_EXERCISE_NAME)2)
#define FIT_MOVE_EXERCISE_NAME_BACK_MASSAGE                                      ((FIT_MOVE_EXERCISE_NAME)3)
#define FIT_MOVE_EXERCISE_NAME_BELLY_BREATHING                                   ((FIT_MOVE_EXERCISE_NAME)4)
#define FIT_MOVE_EXERCISE_NAME_BRIDGE_WITH_BALL                                  ((FIT_MOVE_EXERCISE_NAME)5)
#define FIT_MOVE_EXERCISE_NAME_DIAMOND_LEG_CRUNCH                                ((FIT_MOVE_EXERCISE_NAME)6)
#define FIT_MOVE_EXERCISE_NAME_DIAMOND_LEG_LIFT                                  ((FIT_MOVE_EXERCISE_NAME)7)
#define FIT_MOVE_EXERCISE_NAME_EIGHT_POINT_SHOULDER_OPENER                       ((FIT_MOVE_EXERCISE_NAME)8)
#define FIT_MOVE_EXERCISE_NAME_FOOT_ROLLING                                      ((FIT_MOVE_EXERCISE_NAME)9)
#define FIT_MOVE_EXERCISE_NAME_FOOTWORK                                          ((FIT_MOVE_EXERCISE_NAME)10)
#define FIT_MOVE_EXERCISE_NAME_FOOTWORK_ON_DISC                                  ((FIT_MOVE_EXERCISE_NAME)11)
#define FIT_MOVE_EXERCISE_NAME_FORWARD_FOLD                                      ((FIT_MOVE_EXERCISE_NAME)12)
#define FIT_MOVE_EXERCISE_NAME_FROG_WITH_BAND                                    ((FIT_MOVE_EXERCISE_NAME)13)
#define FIT_MOVE_EXERCISE_NAME_HALF_ROLL_UP                                      ((FIT_MOVE_EXERCISE_NAME)14)
#define FIT_MOVE_EXERCISE_NAME_HAMSTRING_CURL                                    ((FIT_MOVE_EXERCISE_NAME)15)
#define FIT_MOVE_EXERCISE_NAME_HAMSTRING_STRETCH                                 ((FIT_MOVE_EXERCISE_NAME)16)
#define FIT_MOVE_EXERCISE_NAME_HIP_STRETCH                                       ((FIT_MOVE_EXERCISE_NAME)17)
#define FIT_MOVE_EXERCISE_NAME_HUG_A_TREE_WITH_BALL_BAND_AND_WEIGHT              ((FIT_MOVE_EXERCISE_NAME)18)
#define FIT_MOVE_EXERCISE_NAME_KNEE_CIRCLES                                      ((FIT_MOVE_EXERCISE_NAME)19)
#define FIT_MOVE_EXERCISE_NAME_KNEE_FOLDS_ON_DISC                                ((FIT_MOVE_EXERCISE_NAME)20)
#define FIT_MOVE_EXERCISE_NAME_LATERAL_FLEXION                                   ((FIT_MOVE_EXERCISE_NAME)21)
#define FIT_MOVE_EXERCISE_NAME_LEG_STRETCH_WITH_BAND                             ((FIT_MOVE_EXERCISE_NAME)22)
#define FIT_MOVE_EXERCISE_NAME_LEG_STRETCH_WITH_LEG_CIRCLES                      ((FIT_MOVE_EXERCISE_NAME)23)
#define FIT_MOVE_EXERCISE_NAME_LOWER_LIFT_ON_DISC                                ((FIT_MOVE_EXERCISE_NAME)24)
#define FIT_MOVE_EXERCISE_NAME_LUNGE_SQUAT                                       ((FIT_MOVE_EXERCISE_NAME)25)
#define FIT_MOVE_EXERCISE_NAME_LUNGES_WITH_KNEE_LIFT                             ((FIT_MOVE_EXERCISE_NAME)26)
#define FIT_MOVE_EXERCISE_NAME_MERMAID_STRETCH                                   ((FIT_MOVE_EXERCISE_NAME)27)
#define FIT_MOVE_EXERCISE_NAME_NEUTRAL_PELVIC_POSITION                           ((FIT_MOVE_EXERCISE_NAME)28)
#define FIT_MOVE_EXERCISE_NAME_PELVIC_CLOCKS_ON_DISC                             ((FIT_MOVE_EXERCISE_NAME)29)
#define FIT_MOVE_EXERCISE_NAME_PILATES_PLIE_SQUATS_PARALLEL_TURNED_OUT_FLAT_AND_HEELS_WITH_CHAIR ((FIT_MOVE_EXERCISE_NAME)30)
#define FIT_MOVE_EXERCISE_NAME_PIRIFORMIS_STRETCH                                ((FIT_MOVE_EXERCISE_NAME)31)
#define FIT_MOVE_EXERCISE_NAME_PLANK_KNEE_CROSSES                                ((FIT_MOVE_EXERCISE_NAME)32)
#define FIT_MOVE_EXERCISE_NAME_PLANK_KNEE_PULLS                                  ((FIT_MOVE_EXERCISE_NAME)33)
#define FIT_MOVE_EXERCISE_NAME_PLANK_UP_DOWNS                                    ((FIT_MOVE_EXERCISE_NAME)34)
#define FIT_MOVE_EXERCISE_NAME_PRAYER_MUDRA                                      ((FIT_MOVE_EXERCISE_NAME)35)
#define FIT_MOVE_EXERCISE_NAME_PSOAS_LUNGE_STRETCH                               ((FIT_MOVE_EXERCISE_NAME)36)
#define FIT_MOVE_EXERCISE_NAME_RIBCAGE_BREATHING                                 ((FIT_MOVE_EXERCISE_NAME)37)
#define FIT_MOVE_EXERCISE_NAME_ROLL_DOWN                                         ((FIT_MOVE_EXERCISE_NAME)38)
#define FIT_MOVE_EXERCISE_NAME_ROLL_UP_WITH_WEIGHT_AND_BAND                      ((FIT_MOVE_EXERCISE_NAME)39)
#define FIT_MOVE_EXERCISE_NAME_SAW                                               ((FIT_MOVE_EXERCISE_NAME)40)
#define FIT_MOVE_EXERCISE_NAME_SCAPULAR_STABILIZATION                            ((FIT_MOVE_EXERCISE_NAME)41)
#define FIT_MOVE_EXERCISE_NAME_SCISSORS_ON_DISC                                  ((FIT_MOVE_EXERCISE_NAME)42)
#define FIT_MOVE_EXERCISE_NAME_SEATED_HIP_STRETCHUP                              ((FIT_MOVE_EXERCISE_NAME)43)
#define FIT_MOVE_EXERCISE_NAME_SEATED_TWIST                                      ((FIT_MOVE_EXERCISE_NAME)44)
#define FIT_MOVE_EXERCISE_NAME_SHAVING_THE_HEAD_WITH_BALL_BAND_AND_WEIGHT        ((FIT_MOVE_EXERCISE_NAME)45)
#define FIT_MOVE_EXERCISE_NAME_SPINAL_TWIST                                      ((FIT_MOVE_EXERCISE_NAME)46)
#define FIT_MOVE_EXERCISE_NAME_SPINAL_TWIST_STRETCH                              ((FIT_MOVE_EXERCISE_NAME)47)
#define FIT_MOVE_EXERCISE_NAME_SPINE_STRETCH_FORWARD                             ((FIT_MOVE_EXERCISE_NAME)48)
#define FIT_MOVE_EXERCISE_NAME_SQUAT_OPEN_ARM_TWIST_POSE                         ((FIT_MOVE_EXERCISE_NAME)49)
#define FIT_MOVE_EXERCISE_NAME_SQUATS_WITH_BALL                                  ((FIT_MOVE_EXERCISE_NAME)50)
#define FIT_MOVE_EXERCISE_NAME_STAND_AND_HANG                                    ((FIT_MOVE_EXERCISE_NAME)51)
#define FIT_MOVE_EXERCISE_NAME_STANDING_SIDE_STRETCH                             ((FIT_MOVE_EXERCISE_NAME)52)
#define FIT_MOVE_EXERCISE_NAME_STANDING_SINGLE_LEG_FORWARD_BEND_WITH_IT_BAND_OPENER ((FIT_MOVE_EXERCISE_NAME)53)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_CRUNCH_WITH_LEG_LIFT                 ((FIT_MOVE_EXERCISE_NAME)54)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_CRUNCH_WITH_LEG_LIFT_WITH_BALL       ((FIT_MOVE_EXERCISE_NAME)55)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_CRUNCH_WITH_LEGS_CROSSED             ((FIT_MOVE_EXERCISE_NAME)56)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_CRUNCH_WITH_LEGS_CROSSED_WITH_BALL   ((FIT_MOVE_EXERCISE_NAME)57)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_DIAGONAL_CRUNCH                      ((FIT_MOVE_EXERCISE_NAME)58)
#define FIT_MOVE_EXERCISE_NAME_STRAIGHT_LEG_DIAGONAL_CRUNCH_WITH_BALL            ((FIT_MOVE_EXERCISE_NAME)59)
#define FIT_MOVE_EXERCISE_NAME_TAILBONE_CURL                                     ((FIT_MOVE_EXERCISE_NAME)60)
#define FIT_MOVE_EXERCISE_NAME_THROAT_LOCK                                       ((FIT_MOVE_EXERCISE_NAME)61)
#define FIT_MOVE_EXERCISE_NAME_TICK_TOCK_SIDE_ROLL                               ((FIT_MOVE_EXERCISE_NAME)62)
#define FIT_MOVE_EXERCISE_NAME_TWIST                                             ((FIT_MOVE_EXERCISE_NAME)63)
#define FIT_MOVE_EXERCISE_NAME_V_LEG_CRUNCHES                                    ((FIT_MOVE_EXERCISE_NAME)64)
#define FIT_MOVE_EXERCISE_NAME_V_SIT                                             ((FIT_MOVE_EXERCISE_NAME)65)
#define FIT_MOVE_EXERCISE_NAME_FORWARD_FOLD_WHEELCHAIR                           ((FIT_MOVE_EXERCISE_NAME)66)
#define FIT_MOVE_EXERCISE_NAME_FORWARD_FOLD_PLUS_WHEELCHAIR                      ((FIT_MOVE_EXERCISE_NAME)67)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_LOW_FORWARD_WHEELCHAIR                ((FIT_MOVE_EXERCISE_NAME)68)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_MID_FORWARD_WHEELCHAIR                ((FIT_MOVE_EXERCISE_NAME)69)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_HIGH_FORWARD_WHEELCHAIR               ((FIT_MOVE_EXERCISE_NAME)70)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_LOW_BACKWARD_WHEELCHAIR               ((FIT_MOVE_EXERCISE_NAME)71)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_MID_BACKWARD_WHEELCHAIR               ((FIT_MOVE_EXERCISE_NAME)72)
#define FIT_MOVE_EXERCISE_NAME_ARM_CIRCLES_HIGH_BACKWARD_WHEELCHAIR              ((FIT_MOVE_EXERCISE_NAME)73)
#define FIT_MOVE_EXERCISE_NAME_CORE_TWISTS_WHEELCHAIR                            ((FIT_MOVE_EXERCISE_NAME)74)
#define FIT_MOVE_EXERCISE_NAME_ARM_RAISE_WHEELCHAIR                              ((FIT_MOVE_EXERCISE_NAME)75)
#define FIT_MOVE_EXERCISE_NAME_CHEST_EXPAND_WHEELCHAIR                           ((FIT_MOVE_EXERCISE_NAME)76)
#define FIT_MOVE_EXERCISE_NAME_ARM_EXTEND_WHEELCHAIR                             ((FIT_MOVE_EXERCISE_NAME)77)
#define FIT_MOVE_EXERCISE_NAME_FORWARD_BEND_WHEELCHAIR                           ((FIT_MOVE_EXERCISE_NAME)78)
#define FIT_MOVE_EXERCISE_NAME_TOE_TOUCH_WHEELCHAIR                              ((FIT_MOVE_EXERCISE_NAME)79)
#define FIT_MOVE_EXERCISE_NAME_EXTENDED_TOE_TOUCH_WHEELCHAIR                     ((FIT_MOVE_EXERCISE_NAME)80)
#define FIT_MOVE_EXERCISE_NAME_SEATED_ARM_CIRCLES                                ((FIT_MOVE_EXERCISE_NAME)81)
#define FIT_MOVE_EXERCISE_NAME_TRUNK_ROTATIONS                                   ((FIT_MOVE_EXERCISE_NAME)82)
#define FIT_MOVE_EXERCISE_NAME_SEATED_TRUNK_ROTATIONS                            ((FIT_MOVE_EXERCISE_NAME)83)
#define FIT_MOVE_EXERCISE_NAME_TOE_TOUCH                                         ((FIT_MOVE_EXERCISE_NAME)84)
...
#define FIT_POSE_EXERCISE_NAME_ALL_FOURS                                         ((FIT_POSE_EXERCISE_NAME)0)
#define FIT_POSE_EXERCISE_NAME_ANKLE_TO_KNEE                                     ((FIT_POSE_EXERCISE_NAME)1)
#define FIT_POSE_EXERCISE_NAME_BABY_COBRA                                        ((FIT_POSE_EXERCISE_NAME)2)
#define FIT_POSE_EXERCISE_NAME_BOAT                                              ((FIT_POSE_EXERCISE_NAME)3)
#define FIT_POSE_EXERCISE_NAME_BOUND_ANGLE                                       ((FIT_POSE_EXERCISE_NAME)4)
#define FIT_POSE_EXERCISE_NAME_BOUND_SEATED_SINGLE_LEG_FORWARD_BEND              ((FIT_POSE_EXERCISE_NAME)5)
#define FIT_POSE_EXERCISE_NAME_BOW                                               ((FIT_POSE_EXERCISE_NAME)6)
#define FIT_POSE_EXERCISE_NAME_BOWED_HALF_MOON                                   ((FIT_POSE_EXERCISE_NAME)7)
#define FIT_POSE_EXERCISE_NAME_BRIDGE                                            ((FIT_POSE_EXERCISE_NAME)8)
#define FIT_POSE_EXERCISE_NAME_CAT                                               ((FIT_POSE_EXERCISE_NAME)9)
#define FIT_POSE_EXERCISE_NAME_CHAIR                                             ((FIT_POSE_EXERCISE_NAME)10)
#define FIT_POSE_EXERCISE_NAME_CHILDS                                            ((FIT_POSE_EXERCISE_NAME)11)
#define FIT_POSE_EXERCISE_NAME_CORPSE                                            ((FIT_POSE_EXERCISE_NAME)12)
#define FIT_POSE_EXERCISE_NAME_COW_FACE                                          ((FIT_POSE_EXERCISE_NAME)13)
#define FIT_POSE_EXERCISE_NAME_COW                                               ((FIT_POSE_EXERCISE_NAME)14)
#define FIT_POSE_EXERCISE_NAME_DEVOTIONAL_WARRIOR                                ((FIT_POSE_EXERCISE_NAME)15)
#define FIT_POSE_EXERCISE_NAME_DOLPHIN_PLANK                                     ((FIT_POSE_EXERCISE_NAME)16)
#define FIT_POSE_EXERCISE_NAME_DOLPHIN                                           ((FIT_POSE_EXERCISE_NAME)17)
#define FIT_POSE_EXERCISE_NAME_DOWN_DOG_KNEE_TO_NOSE                             ((FIT_POSE_EXERCISE_NAME)18)
#define FIT_POSE_EXERCISE_NAME_DOWN_DOG_SPLIT                                    ((FIT_POSE_EXERCISE_NAME)19)
#define FIT_POSE_EXERCISE_NAME_DOWN_DOG_SPLIT_OPEN_HIP_BENT_KNEE                 ((FIT_POSE_EXERCISE_NAME)20)
#define FIT_POSE_EXERCISE_NAME_DOWNWARD_FACING_DOG                               ((FIT_POSE_EXERCISE_NAME)21)
#define FIT_POSE_EXERCISE_NAME_EAGLE                                             ((FIT_POSE_EXERCISE_NAME)22)
#define FIT_POSE_EXERCISE_NAME_EASY_SEATED                                       ((FIT_POSE_EXERCISE_NAME)23)
#define FIT_POSE_EXERCISE_NAME_EXTENDED_PUPPY                                    ((FIT_POSE_EXERCISE_NAME)24)
#define FIT_POSE_EXERCISE_NAME_EXTENDED_SIDE_ANGLE                               ((FIT_POSE_EXERCISE_NAME)25)
#define FIT_POSE_EXERCISE_NAME_FISH                                              ((FIT_POSE_EXERCISE_NAME)26)
#define FIT_POSE_EXERCISE_NAME_FOUR_LIMBED_STAFF                                 ((FIT_POSE_EXERCISE_NAME)27)
#define FIT_POSE_EXERCISE_NAME_FULL_SPLIT                                        ((FIT_POSE_EXERCISE_NAME)28)
#define FIT_POSE_EXERCISE_NAME_GATE                                              ((FIT_POSE_EXERCISE_NAME)29)
#define FIT_POSE_EXERCISE_NAME_HALF_CHAIR_HALF_ANKLE_TO_KNEE                     ((FIT_POSE_EXERCISE_NAME)30)
#define FIT_POSE_EXERCISE_NAME_HALF_MOON                                         ((FIT_POSE_EXERCISE_NAME)31)
#define FIT_POSE_EXERCISE_NAME_HEAD_TO_KNEE                                      ((FIT_POSE_EXERCISE_NAME)32)
#define FIT_POSE_EXERCISE_NAME_HERON                                             ((FIT_POSE_EXERCISE_NAME)33)
#define FIT_POSE_EXERCISE_NAME_HEROS                                             ((FIT_POSE_EXERCISE_NAME)34)
#define FIT_POSE_EXERCISE_NAME_HIGH_LUNGE                                        ((FIT_POSE_EXERCISE_NAME)35)
#define FIT_POSE_EXERCISE_NAME_KNEES_CHEST_CHIN                                  ((FIT_POSE_EXERCISE_NAME)36)
#define FIT_POSE_EXERCISE_NAME_LIZARD                                            ((FIT_POSE_EXERCISE_NAME)37)
#define FIT_POSE_EXERCISE_NAME_LOCUST                                            ((FIT_POSE_EXERCISE_NAME)38)
#define FIT_POSE_EXERCISE_NAME_LOW_LUNGE                                         ((FIT_POSE_EXERCISE_NAME)39)
#define FIT_POSE_EXERCISE_NAME_LOW_LUNGE_TWIST                                   ((FIT_POSE_EXERCISE_NAME)40)
#define FIT_POSE_EXERCISE_NAME_LOW_LUNGE_WITH_KNEE_DOWN                          ((FIT_POSE_EXERCISE_NAME)41)
#define FIT_POSE_EXERCISE_NAME_MERMAID                                           ((FIT_POSE_EXERCISE_NAME)42)
#define FIT_POSE_EXERCISE_NAME_MOUNTAIN                                          ((FIT_POSE_EXERCISE_NAME)43)
#define FIT_POSE_EXERCISE_NAME_ONE_LEGGED_DOWNWARD_FACING_POSE_OPEN_HIP_BENT_KNEE ((FIT_POSE_EXERCISE_NAME)44)
#define FIT_POSE_EXERCISE_NAME_ONE_LEGGED_PIGEON                                 ((FIT_POSE_EXERCISE_NAME)45)
#define FIT_POSE_EXERCISE_NAME_PEACEFUL_WARRIOR                                  ((FIT_POSE_EXERCISE_NAME)46)
#define FIT_POSE_EXERCISE_NAME_PLANK                                             ((FIT_POSE_EXERCISE_NAME)47)
#define FIT_POSE_EXERCISE_NAME_PLOW                                              ((FIT_POSE_EXERCISE_NAME)48)
#define FIT_POSE_EXERCISE_NAME_RECLINED_HAND_TO_FOOT                             ((FIT_POSE_EXERCISE_NAME)49)
#define FIT_POSE_EXERCISE_NAME_REVOLVED_HALF_MOON                                ((FIT_POSE_EXERCISE_NAME)50)
#define FIT_POSE_EXERCISE_NAME_REVOLVED_HEAD_TO_KNEE                             ((FIT_POSE_EXERCISE_NAME)51)
#define FIT_POSE_EXERCISE_NAME_REVOLVED_TRIANGLE                                 ((FIT_POSE_EXERCISE_NAME)52)
#define FIT_POSE_EXERCISE_NAME_RUNNERS_LUNGE                                     ((FIT_POSE_EXERCISE_NAME)53)
#define FIT_POSE_EXERCISE_NAME_SEATED_EASY_SIDE_BEND                             ((FIT_POSE_EXERCISE_NAME)54)
#define FIT_POSE_EXERCISE_NAME_SEATED_EASY_TWIST                                 ((FIT_POSE_EXERCISE_NAME)55)
#define FIT_POSE_EXERCISE_NAME_SEATED_LONG_LEG_FORWARD_BEND                      ((FIT_POSE_EXERCISE_NAME)56)
#define FIT_POSE_EXERCISE_NAME_SEATED_WIDE_LEG_FORWARD_BEND                      ((FIT_POSE_EXERCISE_NAME)57)
#define FIT_POSE_EXERCISE_NAME_SHOULDER_STAND                                    ((FIT_POSE_EXERCISE_NAME)58)
#define FIT_POSE_EXERCISE_NAME_SIDE_BOAT                                         ((FIT_POSE_EXERCISE_NAME)59)
#define FIT_POSE_EXERCISE_NAME_SIDE_PLANK                                        ((FIT_POSE_EXERCISE_NAME)60)
#define FIT_POSE_EXERCISE_NAME_SPHINX                                            ((FIT_POSE_EXERCISE_NAME)61)
#define FIT_POSE_EXERCISE_NAME_SQUAT_OPEN_ARM_TWIST                              ((FIT_POSE_EXERCISE_NAME)62)
#define FIT_POSE_EXERCISE_NAME_SQUAT_PALM_PRESS                                  ((FIT_POSE_EXERCISE_NAME)63)
#define FIT_POSE_EXERCISE_NAME_STAFF                                             ((FIT_POSE_EXERCISE_NAME)64)
#define FIT_POSE_EXERCISE_NAME_STANDING_ARMS_UP                                  ((FIT_POSE_EXERCISE_NAME)65)
#define FIT_POSE_EXERCISE_NAME_STANDING_FORWARD_BEND_HALFWAY_UP                  ((FIT_POSE_EXERCISE_NAME)66)
#define FIT_POSE_EXERCISE_NAME_STANDING_FORWARD_BEND                             ((FIT_POSE_EXERCISE_NAME)67)
#define FIT_POSE_EXERCISE_NAME_STANDING_SIDE_OPENER                              ((FIT_POSE_EXERCISE_NAME)68)
#define FIT_POSE_EXERCISE_NAME_STANDING_SINGLE_LEG_FORWARD_BEND                  ((FIT_POSE_EXERCISE_NAME)69)
#define FIT_POSE_EXERCISE_NAME_STANDING_SPLIT                                    ((FIT_POSE_EXERCISE_NAME)70)
#define FIT_POSE_EXERCISE_NAME_STANDING_WIDE_LEG_FORWARD_BEND                    ((FIT_POSE_EXERCISE_NAME)71)
#define FIT_POSE_EXERCISE_NAME_STANDING_WIDE_LEG_FORWARD_BEND_WITH_TWIST         ((FIT_POSE_EXERCISE_NAME)72)
#define FIT_POSE_EXERCISE_NAME_SUPINE_SPINAL_TWIST                               ((FIT_POSE_EXERCISE_NAME)73)
#define FIT_POSE_EXERCISE_NAME_TABLE_TOP                                         ((FIT_POSE_EXERCISE_NAME)74)
#define FIT_POSE_EXERCISE_NAME_THREAD_THE_NEEDLE                                 ((FIT_POSE_EXERCISE_NAME)75)
#define FIT_POSE_EXERCISE_NAME_THUNDERBOLT                                       ((FIT_POSE_EXERCISE_NAME)76)
#define FIT_POSE_EXERCISE_NAME_THUNDERBOLT_POSE_BOTH_SIDES_ARM_STRETCH           ((FIT_POSE_EXERCISE_NAME)77)
#define FIT_POSE_EXERCISE_NAME_TREE                                              ((FIT_POSE_EXERCISE_NAME)78)
#define FIT_POSE_EXERCISE_NAME_TRIANGLE                                          ((FIT_POSE_EXERCISE_NAME)79)
#define FIT_POSE_EXERCISE_NAME_UP_DOG                                            ((FIT_POSE_EXERCISE_NAME)80)
#define FIT_POSE_EXERCISE_NAME_UPWARD_FACING_PLANK                               ((FIT_POSE_EXERCISE_NAME)81)
#define FIT_POSE_EXERCISE_NAME_WARRIOR_ONE                                       ((FIT_POSE_EXERCISE_NAME)82)
#define FIT_POSE_EXERCISE_NAME_WARRIOR_THREE                                     ((FIT_POSE_EXERCISE_NAME)83)
#define FIT_POSE_EXERCISE_NAME_WARRIOR_TWO                                       ((FIT_POSE_EXERCISE_NAME)84)
#define FIT_POSE_EXERCISE_NAME_WHEEL                                             ((FIT_POSE_EXERCISE_NAME)85)
#define FIT_POSE_EXERCISE_NAME_WIDE_SIDE_LUNGE                                   ((FIT_POSE_EXERCISE_NAME)86)
#define FIT_POSE_EXERCISE_NAME_DEEP_BREATHING_WHEELCHAIR                         ((FIT_POSE_EXERCISE_NAME)87)
#define FIT_POSE_EXERCISE_NAME_DEEP_BREATHING_LOW_WHEELCHAIR                     ((FIT_POSE_EXERCISE_NAME)88)
#define FIT_POSE_EXERCISE_NAME_DEEP_BREATHING_MID_WHEELCHAIR                     ((FIT_POSE_EXERCISE_NAME)89)
#define FIT_POSE_EXERCISE_NAME_DEEP_BREATHING_HIGH_WHEELCHAIR                    ((FIT_POSE_EXERCISE_NAME)90)
#define FIT_POSE_EXERCISE_NAME_PRAYER_WHEELCHAIR                                 ((FIT_POSE_EXERCISE_NAME)91)
#define FIT_POSE_EXERCISE_NAME_OVERHEAD_PRAYER_WHEELCHAIR                        ((FIT_POSE_EXERCISE_NAME)92)
#define FIT_POSE_EXERCISE_NAME_CACTUS_WHEELCHAIR                                 ((FIT_POSE_EXERCISE_NAME)93)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_WHEELCHAIR                      ((FIT_POSE_EXERCISE_NAME)94)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_EXTENDED_WHEELCHAIR             ((FIT_POSE_EXERCISE_NAME)95)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_OVERHEAD_WHEELCHAIR             ((FIT_POSE_EXERCISE_NAME)96)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_OVERHEAD_AND_DOWN_WHEELCHAIR    ((FIT_POSE_EXERCISE_NAME)97)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_SIDE_WHEELCHAIR                 ((FIT_POSE_EXERCISE_NAME)98)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_EXTENDED_SIDE_WHEELCHAIR        ((FIT_POSE_EXERCISE_NAME)99)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_OVERHEAD_SIDE_WHEELCHAIR        ((FIT_POSE_EXERCISE_NAME)100)
#define FIT_POSE_EXERCISE_NAME_BREATHING_PUNCHES_OVERHEAD_AND_DOWN_SIDE_WHEELCHAIR ((FIT_POSE_EXERCISE_NAME)101)
#define FIT_POSE_EXERCISE_NAME_LEFT_HAND_BACK_WHEELCHAIR                         ((FIT_POSE_EXERCISE_NAME)102)
#define FIT_POSE_EXERCISE_NAME_TRIANGLE_WHEELCHAIR                               ((FIT_POSE_EXERCISE_NAME)103)
#define FIT_POSE_EXERCISE_NAME_THREAD_THE_NEEDLE_WHEELCHAIR                      ((FIT_POSE_EXERCISE_NAME)104)
#define FIT_POSE_EXERCISE_NAME_NECK_FLEXION_AND_EXTENSION_WHEELCHAIR             ((FIT_POSE_EXERCISE_NAME)105)
#define FIT_POSE_EXERCISE_NAME_NECK_LATERAL_FLEXION_WHEELCHAIR                   ((FIT_POSE_EXERCISE_NAME)106)
#define FIT_POSE_EXERCISE_NAME_SPINE_FLEXION_AND_EXTENSION_WHEELCHAIR            ((FIT_POSE_EXERCISE_NAME)107)
#define FIT_POSE_EXERCISE_NAME_SPINE_ROTATION_WHEELCHAIR                         ((FIT_POSE_EXERCISE_NAME)108)
#define FIT_POSE_EXERCISE_NAME_SPINE_LATERAL_FLEXION_WHEELCHAIR                  ((FIT_POSE_EXERCISE_NAME)109)
#define FIT_POSE_EXERCISE_NAME_ALTERNATIVE_SKIING_WHEELCHAIR                     ((FIT_POSE_EXERCISE_NAME)110)
#define FIT_POSE_EXERCISE_NAME_REACH_FORWARD_WHEELCHAIR                          ((FIT_POSE_EXERCISE_NAME)111)
#define FIT_POSE_EXERCISE_NAME_WARRIOR_WHEELCHAIR                                ((FIT_POSE_EXERCISE_NAME)112)
#define FIT_POSE_EXERCISE_NAME_REVERSE_WARRIOR_WHEELCHAIR                        ((FIT_POSE_EXERCISE_NAME)113)
#define FIT_POSE_EXERCISE_NAME_DOWNWARD_FACING_DOG_TO_COBRA                      ((FIT_POSE_EXERCISE_NAME)114)
#define FIT_POSE_EXERCISE_NAME_SEATED_CAT_COW                                    ((FIT_POSE_EXERCISE_NAME)115)
...
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_ALTERNATING_DUMBBELL_LYING_TRICEPS_EXTENSION ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)41)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_TRICEPS_PRESS                        ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)42)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_DUMBBELL_KICKBACK_WHEELCHAIR         ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)43)
#define FIT_TRICEPS_EXTENSION_EXERCISE_NAME_OVERHEAD_DUMBBELL_TRICEPS_EXTENSION_WHEELCHAIR ((FIT_TRICEPS_EXTENSION_EXERCISE_NAME)44)
...
#define FIT_WARM_UP_EXERCISE_NAME_BICEPS_STRETCH                                 ((FIT_WARM_UP_EXERCISE_NAME)31)
#define FIT_WARM_UP_EXERCISE_NAME_GLUTES_STRETCH                                 ((FIT_WARM_UP_EXERCISE_NAME)32)
#define FIT_WARM_UP_EXERCISE_NAME_STANDING_HAMSTRING_STRETCH                     ((FIT_WARM_UP_EXERCISE_NAME)33)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_90_90                                  ((FIT_WARM_UP_EXERCISE_NAME)34)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_ABS                                    ((FIT_WARM_UP_EXERCISE_NAME)35)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_BUTTERFLY                              ((FIT_WARM_UP_EXERCISE_NAME)36)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_CALF                                   ((FIT_WARM_UP_EXERCISE_NAME)37)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_CAT_COW                                ((FIT_WARM_UP_EXERCISE_NAME)38)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_CHILDS_POSE                            ((FIT_WARM_UP_EXERCISE_NAME)39)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_COBRA                                  ((FIT_WARM_UP_EXERCISE_NAME)40)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_FOREARMS                               ((FIT_WARM_UP_EXERCISE_NAME)41)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_FORWARD_GLUTES                         ((FIT_WARM_UP_EXERCISE_NAME)42)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_FRONT_SPLIT                            ((FIT_WARM_UP_EXERCISE_NAME)43)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_HAMSTRING                              ((FIT_WARM_UP_EXERCISE_NAME)44)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_HIP_FLEXOR_AND_QUAD                    ((FIT_WARM_UP_EXERCISE_NAME)45)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LAT                                    ((FIT_WARM_UP_EXERCISE_NAME)46)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LEVATOR_SCAPULAE                       ((FIT_WARM_UP_EXERCISE_NAME)47)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LUNGE_WITH_SPINAL_TWIST                ((FIT_WARM_UP_EXERCISE_NAME)48)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LUNGING_HIP_FLEXOR                     ((FIT_WARM_UP_EXERCISE_NAME)49)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LYING_ABDUCTION                        ((FIT_WARM_UP_EXERCISE_NAME)50)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LYING_IT_BAND                          ((FIT_WARM_UP_EXERCISE_NAME)51)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LYING_KNEE_TO_CHEST                    ((FIT_WARM_UP_EXERCISE_NAME)52)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LYING_PIRIFORMIS                       ((FIT_WARM_UP_EXERCISE_NAME)53)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_LYING_SPINAL_TWIST                     ((FIT_WARM_UP_EXERCISE_NAME)54)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_NECK                                   ((FIT_WARM_UP_EXERCISE_NAME)55)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_OBLIQUES                               ((FIT_WARM_UP_EXERCISE_NAME)56)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_OVER_UNDER_SHOULDER                    ((FIT_WARM_UP_EXERCISE_NAME)57)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_PECTORAL                               ((FIT_WARM_UP_EXERCISE_NAME)58)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_PIGEON_POSE                            ((FIT_WARM_UP_EXERCISE_NAME)59)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_PIRIFORMIS                             ((FIT_WARM_UP_EXERCISE_NAME)60)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_QUAD                                   ((FIT_WARM_UP_EXERCISE_NAME)61)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_SCORPION                               ((FIT_WARM_UP_EXERCISE_NAME)62)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_SHOULDER                               ((FIT_WARM_UP_EXERCISE_NAME)63)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_SIDE                                   ((FIT_WARM_UP_EXERCISE_NAME)64)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_SIDE_LUNGE                             ((FIT_WARM_UP_EXERCISE_NAME)65)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_SIDE_SPLIT                             ((FIT_WARM_UP_EXERCISE_NAME)66)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_STANDING_IT_BAND                       ((FIT_WARM_UP_EXERCISE_NAME)67)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_STRADDLE                               ((FIT_WARM_UP_EXERCISE_NAME)68)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_TRICEPS                                ((FIT_WARM_UP_EXERCISE_NAME)69)
#define FIT_WARM_UP_EXERCISE_NAME_STRETCH_WALL_CHEST_AND_SHOULDER                ((FIT_WARM_UP_EXERCISE_NAME)70)
#define FIT_WARM_UP_EXERCISE_NAME_NECK_ROTATIONS_WHEELCHAIR                      ((FIT_WARM_UP_EXERCISE_NAME)71)
#define FIT_WARM_UP_EXERCISE_NAME_HALF_KNEELING_ARM_ROTATION                     ((FIT_WARM_UP_EXERCISE_NAME)72)
#define FIT_WARM_UP_EXERCISE_NAME_THREE_WAY_ANKLE_MOBILIZATION                   ((FIT_WARM_UP_EXERCISE_NAME)73)
#define FIT_WARM_UP_EXERCISE_NAME_NINETY_NINETY_HIP_SWITCH                       ((FIT_WARM_UP_EXERCISE_NAME)74) // 90_90_hip_switch
#define FIT_WARM_UP_EXERCISE_NAME_ACTIVE_FROG                                    ((FIT_WARM_UP_EXERCISE_NAME)75)
#define FIT_WARM_UP_EXERCISE_NAME_SHOULDER_SWEEPS                                ((FIT_WARM_UP_EXERCISE_NAME)76)
#define FIT_WARM_UP_EXERCISE_NAME_ANKLE_LUNGES                                   ((FIT_WARM_UP_EXERCISE_NAME)77)
#define FIT_WARM_UP_EXERCISE_NAME_BACK_ROLL_FOAM_ROLLER                          ((FIT_WARM_UP_EXERCISE_NAME)78)
#define FIT_WARM_UP_EXERCISE_NAME_BEAR_CRAWL                                     ((FIT_WARM_UP_EXERCISE_NAME)79)
#define FIT_WARM_UP_EXERCISE_NAME_LATISSIMUS_DORSI_FOAM_ROLL                     ((FIT_WARM_UP_EXERCISE_NAME)80)
#define FIT_WARM_UP_EXERCISE_NAME_REVERSE_T_HIP_OPENER                           ((FIT_WARM_UP_EXERCISE_NAME)81)
#define FIT_WARM_UP_EXERCISE_NAME_SHOULDER_ROLLS                                 ((FIT_WARM_UP_EXERCISE_NAME)82)
#define FIT_WARM_UP_EXERCISE_NAME_CHEST_OPENERS                                  ((FIT_WARM_UP_EXERCISE_NAME)83)
#define FIT_WARM_UP_EXERCISE_NAME_TRICEPS_STRETCH                                ((FIT_WARM_UP_EXERCISE_NAME)84)
#define FIT_WARM_UP_EXERCISE_NAME_UPPER_BACK_STRETCH                             ((FIT_WARM_UP_EXERCISE_NAME)85)
#define FIT_WARM_UP_EXERCISE_NAME_HIP_CIRCLES                                    ((FIT_WARM_UP_EXERCISE_NAME)86)
#define FIT_WARM_UP_EXERCISE_NAME_ANKLE_STRETCH                                  ((FIT_WARM_UP_EXERCISE_NAME)87)
#define FIT_WARM_UP_EXERCISE_NAME_MARCHING_IN_PLACE                              ((FIT_WARM_UP_EXERCISE_NAME)88)
#define FIT_WARM_UP_EXERCISE_NAME_TRICEPS_STRETCH_WHEELCHAIR                     ((FIT_WARM_UP_EXERCISE_NAME)89)
#define FIT_WARM_UP_EXERCISE_NAME_UPPER_BACK_STRETCH_WHEELCHAIR                  ((FIT_WARM_UP_EXERCISE_NAME)90)
...
#define FIT_RUN_EXERCISE_NAME_RUN_OR_WALK                                        ((FIT_RUN_EXERCISE_NAME)4)
#define FIT_RUN_EXERCISE_NAME_SPEED_WALK                                         ((FIT_RUN_EXERCISE_NAME)5)
#define FIT_RUN_EXERCISE_NAME_WARM_UP                                            ((FIT_RUN_EXERCISE_NAME)6)
...
#define FIT_BIKE_EXERCISE_NAME_BIKE                                              ((FIT_BIKE_EXERCISE_NAME)0)
#define FIT_BIKE_EXERCISE_NAME_RIDE                                              ((FIT_BIKE_EXERCISE_NAME)1)
#define FIT_BIKE_EXERCISE_NAME_SPRINT                                            ((FIT_BIKE_EXERCISE_NAME)2)
...
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_AB_TWIST                              ((FIT_BANDED_EXERCISES_EXERCISE_NAME)1)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_BACK_EXTENSION                        ((FIT_BANDED_EXERCISES_EXERCISE_NAME)2)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_BICYCLE_CRUNCH                        ((FIT_BANDED_EXERCISES_EXERCISE_NAME)3)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CALF_RAISES                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)4)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CHEST_PRESS                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)5)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CLAM_SHELLS                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)6)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CURL                                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)7)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_DEADBUG                               ((FIT_BANDED_EXERCISES_EXERCISE_NAME)8)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_DEADLIFT                              ((FIT_BANDED_EXERCISES_EXERCISE_NAME)9)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_DONKEY_KICK                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)10)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_EXTERNAL_ROTATION                     ((FIT_BANDED_EXERCISES_EXERCISE_NAME)11)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_EXTERNAL_ROTATION_AT_90_DEGREE_ABDUCTION ((FIT_BANDED_EXERCISES_EXERCISE_NAME)12)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_FACE_PULL                             ((FIT_BANDED_EXERCISES_EXERCISE_NAME)13)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_FIRE_HYDRANT                          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)14)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_FLY                                   ((FIT_BANDED_EXERCISES_EXERCISE_NAME)15)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_FRONT_RAISE                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)16)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_GLUTE_BRIDGE                          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)17)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_HAMSTRING_CURLS                       ((FIT_BANDED_EXERCISES_EXERCISE_NAME)18)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_HIGH_PLANK_LEG_LIFTS                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)19)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_HIP_EXTENSION                         ((FIT_BANDED_EXERCISES_EXERCISE_NAME)20)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_INTERNAL_ROTATION                     ((FIT_BANDED_EXERCISES_EXERCISE_NAME)21)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_JUMPING_JACK                          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)22)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_KNEELING_CRUNCH                       ((FIT_BANDED_EXERCISES_EXERCISE_NAME)23)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LATERAL_BAND_WALKS                    ((FIT_BANDED_EXERCISES_EXERCISE_NAME)24)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LATERAL_RAISE                         ((FIT_BANDED_EXERCISES_EXERCISE_NAME)25)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LATPULL                               ((FIT_BANDED_EXERCISES_EXERCISE_NAME)26)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LEG_ABDUCTION                         ((FIT_BANDED_EXERCISES_EXERCISE_NAME)27)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LEG_ADDUCTION                         ((FIT_BANDED_EXERCISES_EXERCISE_NAME)28)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LEG_EXTENSION                         ((FIT_BANDED_EXERCISES_EXERCISE_NAME)29)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LUNGE                                 ((FIT_BANDED_EXERCISES_EXERCISE_NAME)30)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_PLANK                                 ((FIT_BANDED_EXERCISES_EXERCISE_NAME)31)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_PULL_APART                            ((FIT_BANDED_EXERCISES_EXERCISE_NAME)32)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_PUSH_UPS                              ((FIT_BANDED_EXERCISES_EXERCISE_NAME)33)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_REVERSE_CRUNCH                        ((FIT_BANDED_EXERCISES_EXERCISE_NAME)34)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_ROW                                   ((FIT_BANDED_EXERCISES_EXERCISE_NAME)35)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SHOULDER_ABDUCTION                    ((FIT_BANDED_EXERCISES_EXERCISE_NAME)36)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SHOULDER_EXTENSION                    ((FIT_BANDED_EXERCISES_EXERCISE_NAME)37)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SHOULDER_EXTERNAL_ROTATION            ((FIT_BANDED_EXERCISES_EXERCISE_NAME)38)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SHOULDER_FLEXION_TO_90_DEGREES        ((FIT_BANDED_EXERCISES_EXERCISE_NAME)39)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SIDE_PLANK_LEG_LIFTS                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)40)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SIDE_RAISE                            ((FIT_BANDED_EXERCISES_EXERCISE_NAME)41)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SQUAT                                 ((FIT_BANDED_EXERCISES_EXERCISE_NAME)42)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SQUAT_TO_PRESS                        ((FIT_BANDED_EXERCISES_EXERCISE_NAME)43)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_TRICEP_EXTENSION                      ((FIT_BANDED_EXERCISES_EXERCISE_NAME)44)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_TRICEP_KICKBACK                       ((FIT_BANDED_EXERCISES_EXERCISE_NAME)45)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_UPRIGHT_ROW                           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)46)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_WALL_CRAWL_WITH_EXTERNAL_ROTATION     ((FIT_BANDED_EXERCISES_EXERCISE_NAME)47)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_LATERAL_RAISE_WHEELCHAIR              ((FIT_BANDED_EXERCISES_EXERCISE_NAME)49)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_TRICEPS_EXTENSION_WHEELCHAIR          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)50)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CHEST_FLY_INCLINE_WHEELCHAIR          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)51)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CHEST_FLY_DECLINE_WHEELCHAIR          ((FIT_BANDED_EXERCISES_EXERCISE_NAME)52)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_PULL_DOWN_WHEELCHAIR                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)53)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_STRAIGHT_ARM_PULL_DOWN_WHEELCHAIR     ((FIT_BANDED_EXERCISES_EXERCISE_NAME)54)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_CURL_WHEELCHAIR                       ((FIT_BANDED_EXERCISES_EXERCISE_NAME)55)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_OVERHEAD_CURL_WHEELCHAIR              ((FIT_BANDED_EXERCISES_EXERCISE_NAME)56)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_FACE_PULL_WHEELCHAIR                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)57)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_AROUND_THE_WORLD_WHEELCHAIR           ((FIT_BANDED_EXERCISES_EXERCISE_NAME)58)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_PULL_APART_WHEELCHAIR                 ((FIT_BANDED_EXERCISES_EXERCISE_NAME)59)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_SIDE_CURL_WHEELCHAIR                  ((FIT_BANDED_EXERCISES_EXERCISE_NAME)60)
#define FIT_BANDED_EXERCISES_EXERCISE_NAME_OVERHEAD_PRESS_WHEELCHAIR             ((FIT_BANDED_EXERCISES_EXERCISE_NAME)61)
...
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_FIGURE_EIGHT                   ((FIT_BATTLE_ROPE_EXERCISE_NAME)0)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_JUMP_WAVE                      ((FIT_BATTLE_ROPE_EXERCISE_NAME)1)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_KNEELING_TO_STANDING_WAVE      ((FIT_BATTLE_ROPE_EXERCISE_NAME)2)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_LUNGE_WAVE                     ((FIT_BATTLE_ROPE_EXERCISE_NAME)3)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_SQUAT_WAVE                     ((FIT_BATTLE_ROPE_EXERCISE_NAME)4)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_WAVE                           ((FIT_BATTLE_ROPE_EXERCISE_NAME)5)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ALTERNATING_WAVE_WITH_LATERAL_SHUFFLE      ((FIT_BATTLE_ROPE_EXERCISE_NAME)6)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_CLAP_WAVE                                  ((FIT_BATTLE_ROPE_EXERCISE_NAME)7)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_DOUBLE_ARM_FIGURE_EIGHT                    ((FIT_BATTLE_ROPE_EXERCISE_NAME)8)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_DOUBLE_ARM_SIDE_TO_SIDE_SNAKE              ((FIT_BATTLE_ROPE_EXERCISE_NAME)9)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_DOUBLE_ARM_SIDE_WAVE                       ((FIT_BATTLE_ROPE_EXERCISE_NAME)10)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_DOUBLE_ARM_SLAM                            ((FIT_BATTLE_ROPE_EXERCISE_NAME)11)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_DOUBLE_ARM_WAVE                            ((FIT_BATTLE_ROPE_EXERCISE_NAME)12)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_GRAPPLER_TOSS                              ((FIT_BATTLE_ROPE_EXERCISE_NAME)13)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_HIP_TOSS                                   ((FIT_BATTLE_ROPE_EXERCISE_NAME)14)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_IN_AND_OUT_WAVE                            ((FIT_BATTLE_ROPE_EXERCISE_NAME)15)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_INSIDE_CIRCLE                              ((FIT_BATTLE_ROPE_EXERCISE_NAME)16)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_JUMPING_JACKS                              ((FIT_BATTLE_ROPE_EXERCISE_NAME)17)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_OUTSIDE_CIRCLE                             ((FIT_BATTLE_ROPE_EXERCISE_NAME)18)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_RAINBOW                                    ((FIT_BATTLE_ROPE_EXERCISE_NAME)19)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_SIDE_PLANK_WAVE                            ((FIT_BATTLE_ROPE_EXERCISE_NAME)20)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_SIDEWINDER                                 ((FIT_BATTLE_ROPE_EXERCISE_NAME)21)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_SITTING_RUSSIAN_TWIST                      ((FIT_BATTLE_ROPE_EXERCISE_NAME)22)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_SNAKE_WAVE                                 ((FIT_BATTLE_ROPE_EXERCISE_NAME)23)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_SPLIT_JACK                                 ((FIT_BATTLE_ROPE_EXERCISE_NAME)24)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_STAGE_COACH                                ((FIT_BATTLE_ROPE_EXERCISE_NAME)25)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_ULTIMATE_WARRIOR                           ((FIT_BATTLE_ROPE_EXERCISE_NAME)26)
#define FIT_BATTLE_ROPE_EXERCISE_NAME_UPPER_CUTS                                 ((FIT_BATTLE_ROPE_EXERCISE_NAME)27)
...
#define FIT_ELLIPTICAL_EXERCISE_NAME_ELLIPTICAL                                  ((FIT_ELLIPTICAL_EXERCISE_NAME)0)
...
#define FIT_FLOOR_CLIMB_EXERCISE_NAME_FLOOR_CLIMB                                ((FIT_FLOOR_CLIMB_EXERCISE_NAME)0)
...
#define FIT_INDOOR_BIKE_EXERCISE_NAME_AIR_BIKE                                   ((FIT_INDOOR_BIKE_EXERCISE_NAME)0)
#define FIT_INDOOR_BIKE_EXERCISE_NAME_ASSAULT_BIKE                               ((FIT_INDOOR_BIKE_EXERCISE_NAME)1)
#define FIT_INDOOR_BIKE_EXERCISE_NAME_STATIONARY_BIKE                            ((FIT_INDOOR_BIKE_EXERCISE_NAME)3)
...
#define FIT_INDOOR_ROW_EXERCISE_NAME_ROWING_MACHINE                              ((FIT_INDOOR_ROW_EXERCISE_NAME)0)
...
#define FIT_LADDER_EXERCISE_NAME_AGILITY                                         ((FIT_LADDER_EXERCISE_NAME)0)
#define FIT_LADDER_EXERCISE_NAME_SPEED                                           ((FIT_LADDER_EXERCISE_NAME)1)
...
#define FIT_SANDBAG_EXERCISE_NAME_AROUND_THE_WORLD                               ((FIT_SANDBAG_EXERCISE_NAME)0)
#define FIT_SANDBAG_EXERCISE_NAME_BACK_SQUAT                                     ((FIT_SANDBAG_EXERCISE_NAME)1)
#define FIT_SANDBAG_EXERCISE_NAME_BEAR_CRAWL_PULL_THROUGH                        ((FIT_SANDBAG_EXERCISE_NAME)2)
#define FIT_SANDBAG_EXERCISE_NAME_BEAR_HUG_SQUAT                                 ((FIT_SANDBAG_EXERCISE_NAME)3)
#define FIT_SANDBAG_EXERCISE_NAME_CLEAN                                          ((FIT_SANDBAG_EXERCISE_NAME)4)
#define FIT_SANDBAG_EXERCISE_NAME_CLEAN_AND_PRESS                                ((FIT_SANDBAG_EXERCISE_NAME)5)
#define FIT_SANDBAG_EXERCISE_NAME_CURL                                           ((FIT_SANDBAG_EXERCISE_NAME)6)
#define FIT_SANDBAG_EXERCISE_NAME_FRONT_CARRY                                    ((FIT_SANDBAG_EXERCISE_NAME)7)
#define FIT_SANDBAG_EXERCISE_NAME_FRONT_SQUAT                                    ((FIT_SANDBAG_EXERCISE_NAME)8)
#define FIT_SANDBAG_EXERCISE_NAME_LUNGE                                          ((FIT_SANDBAG_EXERCISE_NAME)9)
#define FIT_SANDBAG_EXERCISE_NAME_OVERHEAD_PRESS                                 ((FIT_SANDBAG_EXERCISE_NAME)10)
#define FIT_SANDBAG_EXERCISE_NAME_PLANK_PULL_THROUGH                             ((FIT_SANDBAG_EXERCISE_NAME)11)
#define FIT_SANDBAG_EXERCISE_NAME_ROTATIONAL_LUNGE                               ((FIT_SANDBAG_EXERCISE_NAME)12)
#define FIT_SANDBAG_EXERCISE_NAME_ROW                                            ((FIT_SANDBAG_EXERCISE_NAME)13)
#define FIT_SANDBAG_EXERCISE_NAME_RUSSIAN_TWIST                                  ((FIT_SANDBAG_EXERCISE_NAME)14)
#define FIT_SANDBAG_EXERCISE_NAME_SHOULDERING                                    ((FIT_SANDBAG_EXERCISE_NAME)15)
#define FIT_SANDBAG_EXERCISE_NAME_SHOVELING                                      ((FIT_SANDBAG_EXERCISE_NAME)16)
#define FIT_SANDBAG_EXERCISE_NAME_SIDE_LUNGE                                     ((FIT_SANDBAG_EXERCISE_NAME)17)
#define FIT_SANDBAG_EXERCISE_NAME_SPRINT                                         ((FIT_SANDBAG_EXERCISE_NAME)18)
#define FIT_SANDBAG_EXERCISE_NAME_ZERCHER_SQUAT                                  ((FIT_SANDBAG_EXERCISE_NAME)19)
...
#define FIT_SLED_EXERCISE_NAME_BACKWARD_DRAG                                     ((FIT_SLED_EXERCISE_NAME)0)
#define FIT_SLED_EXERCISE_NAME_CHEST_PRESS                                       ((FIT_SLED_EXERCISE_NAME)1)
#define FIT_SLED_EXERCISE_NAME_FORWARD_DRAG                                      ((FIT_SLED_EXERCISE_NAME)2)
#define FIT_SLED_EXERCISE_NAME_LOW_PUSH                                          ((FIT_SLED_EXERCISE_NAME)3)
#define FIT_SLED_EXERCISE_NAME_PUSH                                              ((FIT_SLED_EXERCISE_NAME)4)
#define FIT_SLED_EXERCISE_NAME_ROW                                               ((FIT_SLED_EXERCISE_NAME)5)
...
#define FIT_SLEDGE_HAMMER_EXERCISE_NAME_LATERAL_SWING                            ((FIT_SLEDGE_HAMMER_EXERCISE_NAME)0)
#define FIT_SLEDGE_HAMMER_EXERCISE_NAME_HAMMER_SLAM                              ((FIT_SLEDGE_HAMMER_EXERCISE_NAME)1)
...
#define FIT_STAIR_STEPPER_EXERCISE_NAME_STAIR_STEPPER                            ((FIT_STAIR_STEPPER_EXERCISE_NAME)0)
...
#define FIT_SUSPENSION_EXERCISE_NAME_CHEST_FLY                                   ((FIT_SUSPENSION_EXERCISE_NAME)0)
#define FIT_SUSPENSION_EXERCISE_NAME_CHEST_PRESS                                 ((FIT_SUSPENSION_EXERCISE_NAME)1)
#define FIT_SUSPENSION_EXERCISE_NAME_CRUNCH                                      ((FIT_SUSPENSION_EXERCISE_NAME)2)
#define FIT_SUSPENSION_EXERCISE_NAME_CURL                                        ((FIT_SUSPENSION_EXERCISE_NAME)3)
#define FIT_SUSPENSION_EXERCISE_NAME_DIP                                         ((FIT_SUSPENSION_EXERCISE_NAME)4)
#define FIT_SUSPENSION_EXERCISE_NAME_FACE_PULL                                   ((FIT_SUSPENSION_EXERCISE_NAME)5)
#define FIT_SUSPENSION_EXERCISE_NAME_GLUTE_BRIDGE                                ((FIT_SUSPENSION_EXERCISE_NAME)6)
#define FIT_SUSPENSION_EXERCISE_NAME_HAMSTRING_CURL                              ((FIT_SUSPENSION_EXERCISE_NAME)7)
#define FIT_SUSPENSION_EXERCISE_NAME_HIP_DROP                                    ((FIT_SUSPENSION_EXERCISE_NAME)8)
#define FIT_SUSPENSION_EXERCISE_NAME_INVERTED_ROW                                ((FIT_SUSPENSION_EXERCISE_NAME)9)
#define FIT_SUSPENSION_EXERCISE_NAME_KNEE_DRIVE_JUMP                             ((FIT_SUSPENSION_EXERCISE_NAME)10)
#define FIT_SUSPENSION_EXERCISE_NAME_KNEE_TO_CHEST                               ((FIT_SUSPENSION_EXERCISE_NAME)11)
#define FIT_SUSPENSION_EXERCISE_NAME_LAT_PULLOVER                                ((FIT_SUSPENSION_EXERCISE_NAME)12)
#define FIT_SUSPENSION_EXERCISE_NAME_LUNGE                                       ((FIT_SUSPENSION_EXERCISE_NAME)13)
#define FIT_SUSPENSION_EXERCISE_NAME_MOUNTAIN_CLIMBER                            ((FIT_SUSPENSION_EXERCISE_NAME)14)
#define FIT_SUSPENSION_EXERCISE_NAME_PENDULUM                                    ((FIT_SUSPENSION_EXERCISE_NAME)15)
#define FIT_SUSPENSION_EXERCISE_NAME_PIKE                                        ((FIT_SUSPENSION_EXERCISE_NAME)16)
#define FIT_SUSPENSION_EXERCISE_NAME_PLANK                                       ((FIT_SUSPENSION_EXERCISE_NAME)17)
#define FIT_SUSPENSION_EXERCISE_NAME_POWER_PULL                                  ((FIT_SUSPENSION_EXERCISE_NAME)18)
#define FIT_SUSPENSION_EXERCISE_NAME_PULL_UP                                     ((FIT_SUSPENSION_EXERCISE_NAME)19)
#define FIT_SUSPENSION_EXERCISE_NAME_PUSH_UP                                     ((FIT_SUSPENSION_EXERCISE_NAME)20)
#define FIT_SUSPENSION_EXERCISE_NAME_REVERSE_MOUNTAIN_CLIMBER                    ((FIT_SUSPENSION_EXERCISE_NAME)21)
#define FIT_SUSPENSION_EXERCISE_NAME_REVERSE_PLANK                               ((FIT_SUSPENSION_EXERCISE_NAME)22)
#define FIT_SUSPENSION_EXERCISE_NAME_ROLLOUT                                     ((FIT_SUSPENSION_EXERCISE_NAME)23)
#define FIT_SUSPENSION_EXERCISE_NAME_ROW                                         ((FIT_SUSPENSION_EXERCISE_NAME)24)
#define FIT_SUSPENSION_EXERCISE_NAME_SIDE_LUNGE                                  ((FIT_SUSPENSION_EXERCISE_NAME)25)
#define FIT_SUSPENSION_EXERCISE_NAME_SIDE_PLANK                                  ((FIT_SUSPENSION_EXERCISE_NAME)26)
#define FIT_SUSPENSION_EXERCISE_NAME_SINGLE_LEG_DEADLIFT                         ((FIT_SUSPENSION_EXERCISE_NAME)27)
#define FIT_SUSPENSION_EXERCISE_NAME_SINGLE_LEG_SQUAT                            ((FIT_SUSPENSION_EXERCISE_NAME)28)
#define FIT_SUSPENSION_EXERCISE_NAME_SIT_UP                                      ((FIT_SUSPENSION_EXERCISE_NAME)29)
#define FIT_SUSPENSION_EXERCISE_NAME_SPLIT                                       ((FIT_SUSPENSION_EXERCISE_NAME)30)
#define FIT_SUSPENSION_EXERCISE_NAME_SQUAT                                       ((FIT_SUSPENSION_EXERCISE_NAME)31)
#define FIT_SUSPENSION_EXERCISE_NAME_SQUAT_JUMP                                  ((FIT_SUSPENSION_EXERCISE_NAME)32)
#define FIT_SUSPENSION_EXERCISE_NAME_TRICEP_PRESS                                ((FIT_SUSPENSION_EXERCISE_NAME)33)
#define FIT_SUSPENSION_EXERCISE_NAME_Y_FLY                                       ((FIT_SUSPENSION_EXERCISE_NAME)34)
...
#define FIT_TIRE_EXERCISE_NAME_FLIP                                              ((FIT_TIRE_EXERCISE_NAME)0)
...
#define FIT_BIKE_OUTDOOR_EXERCISE_NAME_BIKE                                      ((FIT_BIKE_OUTDOOR_EXERCISE_NAME)0)
...
#define FIT_RUN_INDOOR_EXERCISE_NAME_INDOOR_TRACK_RUN                            ((FIT_RUN_INDOOR_EXERCISE_NAME)0)
#define FIT_RUN_INDOOR_EXERCISE_NAME_TREADMILL                                   ((FIT_RUN_INDOOR_EXERCISE_NAME)1)
...
#define FIT_SLEEP_DISRUPTION_SEVERITY_NONE                                       ((FIT_SLEEP_DISRUPTION_SEVERITY)0)
#define FIT_SLEEP_DISRUPTION_SEVERITY_LOW                                        ((FIT_SLEEP_DISRUPTION_SEVERITY)1)
#define FIT_SLEEP_DISRUPTION_SEVERITY_MEDIUM                                     ((FIT_SLEEP_DISRUPTION_SEVERITY)2)
#define FIT_SLEEP_DISRUPTION_SEVERITY_HIGH                                       ((FIT_SLEEP_DISRUPTION_SEVERITY)3)
...
public:
    ...
    typedef enum
    {
        TRAINING_SETTINGS_MESG_TARGET_DISTANCE,
        TRAINING_SETTINGS_MESG_TARGET_SPEED,
        TRAINING_SETTINGS_MESG_TARGET_TIME,
        TRAINING_SETTINGS_MESG_PRECISE_TARGET_SPEED,
        TRAINING_SETTINGS_MESG_FIELDS
    } TRAINING_SETTINGS_MESG_FIELD_INDEX;
    ...
    typedef enum
    {
        SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_MESSAGE_INDEX,
        SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_TIMESTAMP,
        SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_SEVERITY,
        SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_FIELDS
    } SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_FIELD_INDEX;

    typedef enum
    {
        SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_TIMESTAMP,
        SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_SEVERITY,
        SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_FIELDS
