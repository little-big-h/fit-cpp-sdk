...
#include "fit_sleep_disruption_severity_period_mesg_listener.hpp"
#include "fit_sleep_disruption_overnight_severity_mesg_listener.hpp"
#include "fit_nap_event_mesg_listener.hpp"
...
public:
    ...
    void AddListener(SleepDisruptionSeverityPeriodMesgListener& sleepDisruptionSeverityPeriodMesgListener);
    void RemoveListener(SleepDisruptionSeverityPeriodMesgListener& sleepDisruptionSeverityPeriodMesgListener);
    void AddListener(SleepDisruptionOvernightSeverityMesgListener& sleepDisruptionOvernightSeverityMesgListener);
    void RemoveListener(SleepDisruptionOvernightSeverityMesgListener& sleepDisruptionOvernightSeverityMesgListener);
    void AddListener(NapEventMesgListener& napEventMesgListener);
    void RemoveListener(NapEventMesgListener& napEventMesgListener);
...
private:
    ...
    std::vector<SleepDisruptionSeverityPeriodMesgListener *> sleepDisruptionSeverityPeriodMesgListeners;
    std::vector<SleepDisruptionOvernightSeverityMesgListener *> sleepDisruptionOvernightSeverityMesgListeners;
    std::vector<NapEventMesgListener *> napEventMesgListeners;
