...
void MesgBroadcaster::AddListener(SleepDisruptionSeverityPeriodMesgListener& sleepDisruptionSeverityPeriodMesgListener)
{
   sleepDisruptionSeverityPeriodMesgListeners.push_back(&sleepDisruptionSeverityPeriodMesgListener);
}

void MesgBroadcaster::RemoveListener(SleepDisruptionSeverityPeriodMesgListener& sleepDisruptionSeverityPeriodMesgListener)
{
    std::vector<SleepDisruptionSeverityPeriodMesgListener *>::iterator it = std::find(sleepDisruptionSeverityPeriodMesgListeners.begin(), sleepDisruptionSeverityPeriodMesgListeners.end(), &sleepDisruptionSeverityPeriodMesgListener);
    if (sleepDisruptionSeverityPeriodMesgListeners.end() != it)
    sleepDisruptionSeverityPeriodMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(SleepDisruptionOvernightSeverityMesgListener& sleepDisruptionOvernightSeverityMesgListener)
{
   sleepDisruptionOvernightSeverityMesgListeners.push_back(&sleepDisruptionOvernightSeverityMesgListener);
}

void MesgBroadcaster::RemoveListener(SleepDisruptionOvernightSeverityMesgListener& sleepDisruptionOvernightSeverityMesgListener)
{
    std::vector<SleepDisruptionOvernightSeverityMesgListener *>::iterator it = std::find(sleepDisruptionOvernightSeverityMesgListeners.begin(), sleepDisruptionOvernightSeverityMesgListeners.end(), &sleepDisruptionOvernightSeverityMesgListener);
    if (sleepDisruptionOvernightSeverityMesgListeners.end() != it)
    sleepDisruptionOvernightSeverityMesgListeners.erase(it);
}


void MesgBroadcaster::AddListener(NapEventMesgListener& napEventMesgListener)
{
   napEventMesgListeners.push_back(&napEventMesgListener);
}

void MesgBroadcaster::RemoveListener(NapEventMesgListener& napEventMesgListener)
{
    std::vector<NapEventMesgListener *>::iterator it = std::find(napEventMesgListeners.begin(), napEventMesgListeners.end(), &napEventMesgListener);
    if (napEventMesgListeners.end() != it)
    napEventMesgListeners.erase(it);
}
...
void MesgBroadcaster::OnMesg(Mesg& mesg)
{
    ...
    switch (mesg.GetNum())
    {
        ...
        case FIT_MESG_NUM_SLEEP_DISRUPTION_SEVERITY_PERIOD:
        {
            SleepDisruptionSeverityPeriodMesg sleepDisruptionSeverityPeriodMesg(mesg);
            for (int i=0; i < (int)sleepDisruptionSeverityPeriodMesgListeners.size(); i++)
            sleepDisruptionSeverityPeriodMesgListeners[i]->OnMesg(sleepDisruptionSeverityPeriodMesg);
            break;
        }
        case FIT_MESG_NUM_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY:
        {
            SleepDisruptionOvernightSeverityMesg sleepDisruptionOvernightSeverityMesg(mesg);
            for (int i=0; i < (int)sleepDisruptionOvernightSeverityMesgListeners.size(); i++)
            sleepDisruptionOvernightSeverityMesgListeners[i]->OnMesg(sleepDisruptionOvernightSeverityMesg);
            break;
        }
        case FIT_MESG_NUM_NAP_EVENT:
        {
            NapEventMesg napEventMesg(mesg);
            for (int i=0; i < (int)napEventMesgListeners.size(); i++)
            napEventMesgListeners[i]->OnMesg(napEventMesg);
            break;
        }
