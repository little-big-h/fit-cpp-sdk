...
public:
    ...
    public:
       ...
       static const FIT_UINT8 MetabolicCalories = 196;
    ...
    {
        const Field* field = GetField(196);
        if( FIT_NULL == field )
        {
            return FIT_FALSE;
        }
    ...
    {
        return GetFieldUINT16Value(196, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD);
    }
    ...
    {
        SetFieldUINT16Value(196, metabolicCalories, 0, FIT_SUBFIELD_INDEX_MAIN_FIELD);
    }
